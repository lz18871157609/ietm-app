...
@Component({
  selector: 'app-req-quantity',
  templateUrl: './req-quantity.component.html',
  styleUrls: ['./req-quantity.component.scss'],
})
export class ReqQuantityComponent implements OnInit {
  xmlTag = 'reqQuantityTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqQuantityTemp', {static: true, read: ViewContainerRef}) reqQuantityTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqQuantityTemp.createComponent(nodeComp);
