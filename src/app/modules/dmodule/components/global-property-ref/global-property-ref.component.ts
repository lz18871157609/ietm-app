...
@Component({
  selector: 'app-global-property-ref',
  templateUrl: './global-property-ref.component.html',
  styleUrls: ['./global-property-ref.component.scss'],
})
export class GlobalPropertyRefComponent implements OnInit {

  xmlTag = 'globalPropertyRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('globalPropertyRefTemp', {static: true, read: ViewContainerRef}) globalPropertyRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.globalPropertyRefTemp.createComponent(nodeComp);
