...
@Component({
  selector: 'app-quality-tolerance',
  templateUrl: './quality-tolerance.component.html',
  styleUrls: ['./quality-tolerance.component.scss'],
})
export class QualityToleranceComponent implements OnInit {
  xmlTag = 'qualityToleranceTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('qualityToleranceTemp', {static: true, read: ViewContainerRef}) qualityToleranceTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.qualityToleranceTemp.createComponent(nodeComp);
