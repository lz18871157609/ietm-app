...
export class PersonSkillComponent implements OnInit {
  xmlTag = 'personSkillTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('personSkillTemp', {static: true, read: ViewContainerRef}) personSkillTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.personSkillTemp.createComponent(nodeComp);
