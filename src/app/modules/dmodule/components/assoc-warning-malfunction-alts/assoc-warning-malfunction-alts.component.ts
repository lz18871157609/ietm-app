...
@Component({
  selector: 'app-assoc-warning-malfunction-alts',
  templateUrl: './assoc-warning-malfunction-alts.component.html',
  styleUrls: ['./assoc-warning-malfunction-alts.component.scss'],
})
export class AssocWarningMalfunctionAltsComponent implements OnInit {
  xmlTag = 'assocWarningMalfunctionAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('assocWarningMalfunctionAltsTemp', {static: true, read: ViewContainerRef}) assocWarningMalfunctionAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.assocWarningMalfunctionAltsTemp.createComponent(nodeComp);
