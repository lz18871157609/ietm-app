...
@Component({
  selector: 'app-dialog-alts',
  templateUrl: './dialog-alts.component.html',
  styleUrls: ['./dialog-alts.component.scss'],
})
export class DialogAltsComponent implements OnInit {
  xmlTag = 'dialogAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dialogAltsTemp', {static: true, read: ViewContainerRef}) dialogAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dialogAltsTemp.createComponent(nodeComp);
