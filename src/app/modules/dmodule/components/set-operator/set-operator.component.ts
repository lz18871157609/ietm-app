...
@Component({
  selector: 'app-set-operator',
  templateUrl: './set-operator.component.html',
  styleUrls: ['./set-operator.component.scss'],
})
export class SetOperatorComponent implements OnInit {

xmlTag = 'setOperatorTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('setOperatorTemp', {static: true, read: ViewContainerRef}) setOperatorTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.setOperatorTemp.createComponent(nodeComp);
