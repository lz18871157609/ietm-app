...
@Component({
  selector: 'app-req-tech-info',
  templateUrl: './req-tech-info.component.html',
  styleUrls: ['./req-tech-info.component.scss'],
})
export class ReqTechInfoComponent implements OnInit {
  xmlTag = 'reqTechInfoTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqTechInfoTemp', {static: true, read: ViewContainerRef}) reqTechInfoTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqTechInfoTemp.createComponent(nodeComp);
