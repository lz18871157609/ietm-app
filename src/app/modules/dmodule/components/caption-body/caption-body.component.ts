...
export class CaptionBodyComponent implements OnInit {
  xmlTag = 'captionBodyTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('captionBodyTemp', {static: true, read: ViewContainerRef}) captionBodyTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.captionBodyTemp.createComponent(nodeComp);
