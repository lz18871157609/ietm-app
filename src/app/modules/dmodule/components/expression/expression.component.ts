...
export class ExpressionComponent implements OnInit {
  xmlTag = 'expressionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('expressionTemp', {static: true, read: ViewContainerRef}) expressionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.expressionTemp.createComponent(nodeComp);
