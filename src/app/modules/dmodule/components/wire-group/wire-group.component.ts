...
@Component({
  selector: 'app-wire-group',
  templateUrl: './wire-group.component.html',
  styleUrls: ['./wire-group.component.scss'],
})
export class WireGroupComponent implements OnInit {
xmlTag = 'wireGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('wireGroupTemp', {static: true, read: ViewContainerRef}) wireGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.wireGroupTemp.createComponent(nodeComp);
