...
export class RandomListComponent implements OnInit {
  xmlTag = 'randomListTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('randomListTemp', {static: true, read: ViewContainerRef}) randomListTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.randomListTemp.createComponent(nodeComp);
