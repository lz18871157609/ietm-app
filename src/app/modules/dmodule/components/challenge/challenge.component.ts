...
export class ChallengeComponent implements OnInit {
  ...
  xmlTag = 'challengeTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('challengeTemp', {static: true, read: ViewContainerRef}) challengeTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.challengeTemp.createComponent(nodeComp);
