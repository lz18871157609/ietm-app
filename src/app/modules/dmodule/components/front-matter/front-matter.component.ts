...
@Component({
  selector: 'app-front-matter',
  templateUrl: './front-matter.component.html',
  styleUrls: ['./front-matter.component.scss'],
})
export class FrontMatterComponent implements OnInit {
  xmlTag = 'frontMatterTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('frontMatterTemp', {static: true, read: ViewContainerRef}) frontMatterTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.frontMatterTemp.createComponent(nodeComp);
