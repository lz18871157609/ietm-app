...
@Component({
  selector: 'app-returned-value-position',
  templateUrl: './returned-value-position.component.html',
  styleUrls: ['./returned-value-position.component.scss'],
})
export class ReturnedValuePositionComponent implements OnInit {
  xmlTag = 'returnedValuePositionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('returnedValuePositionTemp', {static: true, read: ViewContainerRef}) returnedValuePositionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.returnedValuePositionTemp.createComponent(nodeComp);
