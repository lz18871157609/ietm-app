...
@Component({
  selector: 'app-pm-ref-ident',
  templateUrl: './pm-ref-ident.component.html',
  styleUrls: ['./pm-ref-ident.component.scss'],
})
export class PmRefIdentComponent implements OnInit {
  xmlTag = 'pmRefIdentTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('pmRefIdentTemp', {static: true, read: ViewContainerRef}) pmRefIdentTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.pmRefIdentTemp.createComponent(nodeComp);
