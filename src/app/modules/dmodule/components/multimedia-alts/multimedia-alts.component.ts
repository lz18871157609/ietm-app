...
@Component({
  selector: 'app-multimedia-alts',
  templateUrl: './multimedia-alts.component.html',
  styleUrls: ['./multimedia-alts.component.scss'],
})
export class MultimediaAltsComponent implements OnInit {

  xmlTag = 'multimediaAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('multimediaAltsTemp', {static: true, read: ViewContainerRef}) multimediaAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.multimediaAltsTemp.createComponent(nodeComp);
