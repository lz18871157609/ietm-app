...
@Component({
  selector: 'app-boolean-operator',
  templateUrl: './boolean-operator.component.html',
  styleUrls: ['./boolean-operator.component.scss'],
})
export class BooleanOperatorComponent implements OnInit {
  xmlTag = 'booleanOperatorTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('booleanOperatorTemp', {static: true, read: ViewContainerRef}) booleanOperatorTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.booleanOperatorTemp.createComponent(nodeComp);
