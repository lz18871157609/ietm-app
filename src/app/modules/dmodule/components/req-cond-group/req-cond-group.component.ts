...
@Component({
  selector: 'app-req-cond-group',
  templateUrl: './req-cond-group.component.html',
  styleUrls: ['./req-cond-group.component.scss'],
})
export class ReqCondGroupComponent implements OnInit {
  xmlTag = 'reqCondGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqCondGroupTemp', {static: true, read: ViewContainerRef}) reqCondGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqCondGroupTemp.createComponent(nodeComp);
