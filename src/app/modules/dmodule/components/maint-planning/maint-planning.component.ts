...
@Component({
  selector: 'app-maint-planning',
  templateUrl: './maint-planning.component.html',
  styleUrls: ['./maint-planning.component.scss'],
})
export class MaintPlanningComponent implements OnInit {

  xmlTag = 'maintPlanningTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('maintPlanningTemp', {static: true, read: ViewContainerRef}) maintPlanningTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.maintPlanningTemp.createComponent(nodeComp);
