...
@Component({
  selector: 'app-isolated-fault',
  templateUrl: './isolated-fault.component.html',
  styleUrls: ['./isolated-fault.component.scss'],
})
export class IsolatedFaultComponent implements OnInit {

  xmlTag = 'isolatedFaultTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('isolatedFaultTemp', {static: true, read: ViewContainerRef}) isolatedFaultTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.isolatedFaultTemp.createComponent(nodeComp);
