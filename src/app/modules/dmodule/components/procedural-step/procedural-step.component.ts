...
@Component({
  selector: 'app-procedural-step',
  templateUrl: './procedural-step.component.html',
  styleUrls: ['./procedural-step.component.scss'],
})
export class ProceduralStepComponent implements OnInit {
  xmlTag = 'proceduralStepTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('proceduralStepTemp', {static: true, read: ViewContainerRef}) proceduralStepTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.proceduralStepTemp.createComponent(nodeComp);
