...
@Component({
  selector: 'app-fault-isolation-test',
  templateUrl: './fault-isolation-test.component.html',
  styleUrls: ['./fault-isolation-test.component.scss'],
})
export class FaultIsolationTestComponent implements OnInit {
  xmlTag = 'faultIsolationTestTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultIsolationTestTemp', {static: true, read: ViewContainerRef}) faultIsolationTestTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultIsolationTestTemp.createComponent(nodeComp);
