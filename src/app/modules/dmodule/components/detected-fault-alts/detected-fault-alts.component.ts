...
@Component({
  selector: 'app-detected-fault-alts',
  templateUrl: './detected-fault-alts.component.html',
  styleUrls: ['./detected-fault-alts.component.scss'],
})
export class DetectedFaultAltsComponent implements OnInit {
  xmlTag = 'detectedFaultAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('detectedFaultAltsTemp', {static: true, read: ViewContainerRef}) detectedFaultAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.detectedFaultAltsTemp.createComponent(nodeComp);
