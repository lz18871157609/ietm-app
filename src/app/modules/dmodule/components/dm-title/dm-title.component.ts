...
@Component({
  selector: 'app-dm-title',
  templateUrl: './dm-title.component.html',
  styleUrls: ['./dm-title.component.scss'],
  providers: [DynamicDmComponentService]
})
export class DmTitleComponent implements OnInit {
  xmlTag = 'action';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmTitleTemp', {static: true, read: ViewContainerRef}) dmTitleTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmTitleTemp.createComponent(nodeComp);
