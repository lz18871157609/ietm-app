...
@Component({
  selector: 'app-basic-correlated-faults',
  templateUrl: './basic-correlated-faults.component.html',
  styleUrls: ['./basic-correlated-faults.component.scss'],
})
export class BasicCorrelatedFaultsComponent implements OnInit {
  xmlTag = 'basicCorrelatedFaultsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('basicCorrelatedFaultsTemp', {static: true, read: ViewContainerRef}) basicCorrelatedFaultsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.basicCorrelatedFaultsTemp.createComponent(nodeComp);
