...
@Component({
  selector: 'app-isolate-detected-fault',
  templateUrl: './isolate-detected-fault.component.html',
  styleUrls: ['./isolate-detected-fault.component.scss'],
})
export class IsolateDetectedFaultComponent implements OnInit {

  xmlTag = 'isolateDetectedFaultTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('isolateDetectedFaultTemp', {static: true, read: ViewContainerRef}) isolateDetectedFaultTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.isolateDetectedFaultTemp.createComponent(nodeComp);
