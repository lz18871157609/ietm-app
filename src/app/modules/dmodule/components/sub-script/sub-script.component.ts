...
@Component({
  ...
  styleUrls: ['./sub-script.component.scss'],
})
export class SubScriptComponent implements OnInit {

xmlTag = 'subScriptTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('subScriptTemp', {static: true, read: ViewContainerRef}) subScriptTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.subScriptTemp.createComponent(nodeComp);
