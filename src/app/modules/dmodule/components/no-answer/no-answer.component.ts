...
@Component({
  ...
  styleUrls: ['./no-answer.component.scss'],
})
export class NoAnswerComponent implements OnInit {
  xmlTag = 'noAnswerTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('noAnswerTemp', {static: true, read: ViewContainerRef}) noAnswerTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.noAnswerTemp.createComponent(nodeComp);
