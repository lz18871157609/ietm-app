...
@Component({
  selector: 'app-set-function',
  templateUrl: './set-function.component.html',
  styleUrls: ['./set-function.component.scss'],
})
export class SetFunctionComponent implements OnInit {

xmlTag = 'setFunctionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('setFunctionTemp', {static: true, read: ViewContainerRef}) setFunctionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.setFunctionTemp.createComponent(nodeComp);
