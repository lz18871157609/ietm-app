...
@Component({
  selector: 'app-external-pub-ref-address-items',
  templateUrl: './external-pub-ref-address-items.component.html',
  styleUrls: ['./external-pub-ref-address-items.component.scss'],
})
export class ExternalPubRefAddressItemsComponent implements OnInit {
  xmlTag = 'externalPubRefAddressItemsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('externalPubRefAddressItemsTemp', {static: true, read: ViewContainerRef}) externalPubRefAddressItemsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.externalPubRefAddressItemsTemp.createComponent(nodeComp);
