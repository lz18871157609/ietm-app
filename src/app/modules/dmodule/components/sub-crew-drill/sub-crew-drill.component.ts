...
@Component({
  selector: 'app-sub-crew-drill',
  templateUrl: './sub-crew-drill.component.html',
  styleUrls: ['./sub-crew-drill.component.scss'],
})
export class SubCrewDrillComponent implements OnInit {

xmlTag = 'subCrewDrillTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('subCrewDrillTemp', {static: true, read: ViewContainerRef}) subCrewDrillTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.subCrewDrillTemp.createComponent(nodeComp);
