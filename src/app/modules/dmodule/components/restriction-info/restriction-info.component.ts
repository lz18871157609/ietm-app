...
@Component({
  selector: 'app-restriction-info',
  templateUrl: './restriction-info.component.html',
  styleUrls: ['./restriction-info.component.scss'],
})
export class RestrictionInfoComponent implements OnInit {
  xmlTag = 'restrictionInfoTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('restrictionInfoTemp', {static: true, read: ViewContainerRef}) restrictionInfoTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.restrictionInfoTemp.createComponent(nodeComp);
