...
@Component({
  selector: 'app-tgroup',
  templateUrl: './tgroup.component.html',
  styleUrls: ['./tgroup.component.scss'],
})
export class TgroupComponent implements OnInit {

  xmlTag = 'tgroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('tgroupTemp', {static: true, read: ViewContainerRef}) tgroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.tgroupTemp.createComponent(nodeComp);
