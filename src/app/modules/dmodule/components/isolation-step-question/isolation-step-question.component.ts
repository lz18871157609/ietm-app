...
@Component({
  selector: 'app-isolation-step-question',
  templateUrl: './isolation-step-question.component.html',
  styleUrls: ['./isolation-step-question.component.scss'],
})
export class IsolationStepQuestionComponent implements OnInit {


  xmlTag = 'isolationStepQuestionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('isolationStepQuestionTemp', {static: true, read: ViewContainerRef}) isolationStepQuestionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.isolationStepQuestionTemp.createComponent(nodeComp);
