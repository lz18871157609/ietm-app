...
@Component({
  selector: 'app-sco-content',
  templateUrl: './sco-content.component.html',
  styleUrls: ['./sco-content.component.scss'],
})
export class ScoContentComponent implements OnInit {

xmlTag = 'scoContentTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('scoContentTemp', {static: true, read: ViewContainerRef}) scoContentTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.scoContentTemp.createComponent(nodeComp);
