...
@Component({
  ...
  styleUrls: ['./proced.component.scss'],
})
export class ProcedComponent implements OnInit {
  xmlTag = 'procedTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('procedTemp', {static: true, read: ViewContainerRef}) procedTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.procedTemp.createComponent(nodeComp);
