...
@Component({
  selector: 'app-descr-crewd',
  templateUrl: './descr-crewd.component.html',
  styleUrls: ['./descr-crewd.component.scss'],
})
export class DescrCrewdComponent implements OnInit {
  xmlTag = 'descrCrewdTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('descrCrewdTemp', {static: true, read: ViewContainerRef}) descrCrewdTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.descrCrewdTemp.createComponent(nodeComp);
