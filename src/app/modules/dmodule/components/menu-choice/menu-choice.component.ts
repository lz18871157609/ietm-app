...
export class MenuChoiceComponent implements OnInit {
  ...
  xmlTag = 'menuChoiceTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('menuChoiceTemp', {static: true, read: ViewContainerRef}) menuChoiceTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.menuChoiceTemp.createComponent(nodeComp);
