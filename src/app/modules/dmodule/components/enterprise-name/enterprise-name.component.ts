...
@Component({
  ...
  styleUrls: ['./enterprise-name.component.scss'],
})
export class EnterpriseNameComponent implements OnInit {

  xmlTag = 'enterpriseNameTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('enterpriseNameTemp', {static: true, read: ViewContainerRef}) enterpriseNameTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.enterpriseNameTemp.createComponent(nodeComp);
