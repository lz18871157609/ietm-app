...
@Component({
  selector: 'app-fault-equip',
  templateUrl: './fault-equip.component.html',
  styleUrls: ['./fault-equip.component.scss'],
})
export class FaultEquipComponent implements OnInit {
  xmlTag = 'faultEquipTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultEquipTemp', {static: true, read: ViewContainerRef}) faultEquipTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultEquipTemp.createComponent(nodeComp);
