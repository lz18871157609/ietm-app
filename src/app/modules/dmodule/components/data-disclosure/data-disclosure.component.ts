...
export class DataDisclosureComponent implements OnInit {
  xmlTag = 'dataDisclosureTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dataDisclosureTemp', {static: true, read: ViewContainerRef}) dataDisclosureTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dataDisclosureTemp.createComponent(nodeComp);
