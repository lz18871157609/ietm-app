...
@Component({
  selector: 'app-spanspec',
  templateUrl: './spanspec.component.html',
  styleUrls: ['./spanspec.component.scss'],
})
export class SpanspecComponent implements OnInit {

xmlTag = 'spanspecTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('spanspecTemp', {static: true, read: ViewContainerRef}) spanspecTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.spanspecTemp.createComponent(nodeComp);
