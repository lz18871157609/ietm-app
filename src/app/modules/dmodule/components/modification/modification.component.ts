...
export class ModificationComponent implements OnInit {
  ...
  xmlTag = 'modificationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('modificationTemp', {static: true, read: ViewContainerRef}) modificationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.modificationTemp.createComponent(nodeComp);
