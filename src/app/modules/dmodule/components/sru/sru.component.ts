...
@Component({
  selector: 'app-sru',
  templateUrl: './sru.component.html',
  styleUrls: ['./sru.component.scss'],
})
export class SruComponent implements OnInit {

xmlTag = 'sruTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('sruTemp', {static: true, read: ViewContainerRef}) sruTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.sruTemp.createComponent(nodeComp);
