...
xmlTag = 'skillLevelTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('skillLevelTemp', {static: true, read: ViewContainerRef}) skillLevelTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.skillLevelTemp.createComponent(nodeComp);
