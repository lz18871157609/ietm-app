...
@Component({
  selector: 'app-circuit-breaker-location',
  templateUrl: './circuit-breaker-location.component.html',
  styleUrls: ['./circuit-breaker-location.component.scss'],
})
export class CircuitBreakerLocationComponent implements OnInit {
  xmlTag = 'circuitBreakerLocationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('circuitBreakerLocationTemp', {static: true, read: ViewContainerRef}) circuitBreakerLocationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.circuitBreakerLocationTemp.createComponent(nodeComp);
