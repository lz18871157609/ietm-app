...
@Component({
  selector: 'app-caution-ref',
  templateUrl: './caution-ref.component.html',
  styleUrls: ['./caution-ref.component.scss'],
})
export class CautionRefComponent implements OnInit {
  xmlTag = 'cautionRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('cautionRefTemp', {static: true, read: ViewContainerRef}) cautionRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.cautionRefTemp.createComponent(nodeComp);
