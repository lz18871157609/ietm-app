...
@Component({
  selector: 'app-reason-for-amendment',
  templateUrl: './reason-for-amendment.component.html',
  styleUrls: ['./reason-for-amendment.component.scss'],
})
export class ReasonForAmendmentComponent implements OnInit {
  xmlTag = 'reasonForAmendmentTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reasonForAmendmentTemp', {static: true, read: ViewContainerRef}) reasonForAmendmentTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reasonForAmendmentTemp.createComponent(nodeComp);
