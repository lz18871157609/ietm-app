...
@Component({
  selector: 'app-functional-item-code',
  templateUrl: './functional-item-code.component.html',
  styleUrls: ['./functional-item-code.component.scss'],
})
export class FunctionalItemCodeComponent implements OnInit {
  xmlTag = 'functionalItemCodeTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('functionalItemCodeTemp', {static: true, read: ViewContainerRef}) functionalItemCodeTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.functionalItemCodeTemp.createComponent(nodeComp);
