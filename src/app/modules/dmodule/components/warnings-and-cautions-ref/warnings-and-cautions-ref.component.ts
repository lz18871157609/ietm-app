...
@Component({
  selector: 'app-warnings-and-cautions-ref',
  templateUrl: './warnings-and-cautions-ref.component.html',
  styleUrls: ['./warnings-and-cautions-ref.component.scss'],
})
export class WarningsAndCautionsRefComponent implements OnInit {
xmlTag = 'warningsAndCautionsRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('warningsAndCautionsRefTemp', {static: true, read: ViewContainerRef}) warningsAndCautionsRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.warningsAndCautionsRefTemp.createComponent(nodeComp);
