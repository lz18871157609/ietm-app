...
@Component({
  selector: 'app-string-function',
  templateUrl: './string-function.component.html',
  styleUrls: ['./string-function.component.scss'],
})
export class StringFunctionComponent implements OnInit {

xmlTag = 'stringFunctionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('stringFunctionTemp', {static: true, read: ViewContainerRef}) stringFunctionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.stringFunctionTemp.createComponent(nodeComp);
