...
@Component({
  selector: 'app-req-cond',
  templateUrl: './req-cond.component.html',
  styleUrls: ['./req-cond.component.scss'],
})
export class ReqCondComponent implements OnInit {
  xmlTag = 'reqCondTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqCondTemp', {static: true, read: ViewContainerRef}) reqCondTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqCondTemp.createComponent(nodeComp);
