...
@Component({
  selector: 'app-wiring-possible-cause-to',
  templateUrl: './wiring-possible-cause-to.component.html',
  styleUrls: ['./wiring-possible-cause-to.component.scss'],
})
export class WiringPossibleCauseToComponent implements OnInit {
xmlTag = 'wiringPossibleCauseToTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('wiringPossibleCauseToTemp', {static: true, read: ViewContainerRef}) wiringPossibleCauseToTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.wiringPossibleCauseToTemp.createComponent(nodeComp);
