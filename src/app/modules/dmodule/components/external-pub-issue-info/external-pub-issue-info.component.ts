...
@Component({
  selector: 'app-external-pub-issue-info',
  templateUrl: './external-pub-issue-info.component.html',
  styleUrls: ['./external-pub-issue-info.component.scss'],
})
export class ExternalPubIssueInfoComponent implements OnInit {
  xmlTag = 'externalPubIssueInfoTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('externalPubIssueInfoTemp', {static: true, read: ViewContainerRef}) externalPubIssueInfoTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.externalPubIssueInfoTemp.createComponent(nodeComp);
