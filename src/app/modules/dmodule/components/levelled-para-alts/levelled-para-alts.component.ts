...
@Component({
  selector: 'app-levelled-para-alts',
  templateUrl: './levelled-para-alts.component.html',
  styleUrls: ['./levelled-para-alts.component.scss'],
})
export class LevelledParaAltsComponent implements OnInit {

  xmlTag = 'levelledParaAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('levelledParaAltsTemp', {static: true, read: ViewContainerRef}) levelledParaAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.levelledParaAltsTemp.createComponent(nodeComp);
