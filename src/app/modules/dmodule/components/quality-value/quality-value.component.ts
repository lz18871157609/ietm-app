...
@Component({
  selector: 'app-quality-value',
  templateUrl: './quality-value.component.html',
  styleUrls: ['./quality-value.component.scss'],
})
export class QualityValueComponent implements OnInit {
  xmlTag = 'qualityValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('qualityValueTemp', {static: true, read: ViewContainerRef}) qualityValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.qualityValueTemp.createComponent(nodeComp);
