...
@Component({
  selector: 'app-possible-cause-group',
  templateUrl: './possible-cause-group.component.html',
  styleUrls: ['./possible-cause-group.component.scss'],
})
export class PossibleCauseGroupComponent implements OnInit {
  xmlTag = 'possibleCauseGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('possibleCauseGroupTemp', {static: true, read: ViewContainerRef}) possibleCauseGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.possibleCauseGroupTemp.createComponent(nodeComp);
