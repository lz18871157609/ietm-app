...
@Component({
  selector: 'app-crew-drill',
  templateUrl: './crew-drill.component.html',
  styleUrls: ['./crew-drill.component.scss'],
})
export class CrewDrillComponent implements OnInit {
  xmlTag = 'crewDrillTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('crewDrillTemp', {static: true, read: ViewContainerRef}) crewDrillTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.crewDrillTemp.createComponent(nodeComp);
