...
@Component({
  selector: 'app-referenced-applic-group-ref',
  templateUrl: './referenced-applic-group-ref.component.html',
  styleUrls: ['./referenced-applic-group-ref.component.scss'],
})
export class ReferencedApplicGroupRefComponent implements OnInit {
  xmlTag = 'referencedApplicGroupRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('referencedApplicGroupRefTemp', {static: true, read: ViewContainerRef}) referencedApplicGroupRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.referencedApplicGroupRefTemp.createComponent(nodeComp);
