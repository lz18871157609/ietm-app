...
@Component({
  selector: 'app-string-operator',
  templateUrl: './string-operator.component.html',
  styleUrls: ['./string-operator.component.scss'],
})
export class StringOperatorComponent implements OnInit {

xmlTag = 'stringOperatorTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('stringOperatorTemp', {static: true, read: ViewContainerRef}) stringOperatorTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.stringOperatorTemp.createComponent(nodeComp);
