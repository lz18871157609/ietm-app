...
@Component({
  selector: 'app-false-value',
  templateUrl: './false-value.component.html',
  styleUrls: ['./false-value.component.scss'],
})
export class FalseValueComponent implements OnInit {
  xmlTag = 'falseValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('falseValueTemp', {static: true, read: ViewContainerRef}) falseValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.falseValueTemp.createComponent(nodeComp);
