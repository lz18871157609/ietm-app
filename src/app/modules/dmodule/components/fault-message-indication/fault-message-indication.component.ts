...
@Component({
  selector: 'app-fault-message-indication',
  templateUrl: './fault-message-indication.component.html',
  styleUrls: ['./fault-message-indication.component.scss'],
})
export class FaultMessageIndicationComponent implements OnInit {
  xmlTag = 'faultmessageIndicationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultmessageIndicationTemp', {static: true, read: ViewContainerRef}) faultmessageIndicationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultmessageIndicationTemp.createComponent(nodeComp);
