...
@Component({
  ...
  styleUrls: ['./policy-statement.component.scss'],
})
export class PolicyStatementComponent implements OnInit {
  xmlTag = 'policyStatementTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('policyStatementTemp', {static: true, read: ViewContainerRef}) policyStatementTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.policyStatementTemp.createComponent(nodeComp);
