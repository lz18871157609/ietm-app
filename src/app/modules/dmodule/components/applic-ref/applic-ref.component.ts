...
@Component({
  selector: 'app-applic-ref',
  templateUrl: './applic-ref.component.html',
  styleUrls: ['./applic-ref.component.scss'],
})
export class ApplicRefComponent implements OnInit {
  xmlTag = 'applicRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('applicRefTemp', {static: true, read: ViewContainerRef}) applicRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.applicRefTemp.createComponent(nodeComp);
