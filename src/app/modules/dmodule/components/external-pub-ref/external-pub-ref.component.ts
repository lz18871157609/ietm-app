...
@Component({
  selector: 'app-external-pub-ref',
  templateUrl: './external-pub-ref.component.html',
  styleUrls: ['./external-pub-ref.component.scss'],
})
export class ExternalPubRefComponent implements OnInit {

  xmlTag = 'externalPubRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('externalPubRefTemp', {static: true, read: ViewContainerRef}) externalPubRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.externalPubRefTemp.createComponent(nodeComp);
