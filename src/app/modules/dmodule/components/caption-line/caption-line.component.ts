...
@Component({
  selector: 'app-caption-line',
  templateUrl: './caption-line.component.html',
  styleUrls: ['./caption-line.component.scss'],
})
export class CaptionLineComponent implements OnInit {
  xmlTag = 'captionLineTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('captionLineTemp', {static: true, read: ViewContainerRef}) captionLineTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.captionLineTemp.createComponent(nodeComp);
