...
@Component({
  selector: 'app-note-para',
  templateUrl: './note-para.component.html',
  styleUrls: ['./note-para.component.scss'],
})
export class NoteParaComponent implements OnInit {

  xmlTag = 'noteParaTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('noteParaTemp', {static: true, read: ViewContainerRef}) noteParaTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.noteParaTemp.createComponent(nodeComp);
