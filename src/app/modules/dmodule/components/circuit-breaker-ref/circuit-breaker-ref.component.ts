...
@Component({
  selector: 'app-circuit-breaker-ref',
  templateUrl: './circuit-breaker-ref.component.html',
  styleUrls: ['./circuit-breaker-ref.component.scss'],
})
export class CircuitBreakerRefComponent implements OnInit {

  xmlTag = 'circuitBreakerRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('circuitBreakerRefTemp', {static: true, read: ViewContainerRef}) circuitBreakerRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.circuitBreakerRefTemp.createComponent(nodeComp);
