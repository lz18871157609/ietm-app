...
@Component({
  selector: 'app-dm-loop',
  templateUrl: './dm-loop.component.html',
  styleUrls: ['./dm-loop.component.scss'],
})
export class DmLoopComponent implements OnInit {
  xmlTag = 'dmLoopTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmLoopTemp', {static: true, read: ViewContainerRef}) dmLoopTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmLoopTemp.createComponent(nodeComp);
