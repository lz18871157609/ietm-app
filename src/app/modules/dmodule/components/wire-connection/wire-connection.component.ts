...
@Component({
  selector: 'app-wire-connection',
  templateUrl: './wire-connection.component.html',
  styleUrls: ['./wire-connection.component.scss'],
})
export class WireConnectionComponent implements OnInit {
xmlTag = 'wireConnectionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('wireConnectionTemp', {static: true, read: ViewContainerRef}) wireConnectionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.wireConnectionTemp.createComponent(nodeComp);
