...
@Component({
  selector: 'app-export-registration-code',
  templateUrl: './export-registration-code.component.html',
  styleUrls: ['./export-registration-code.component.scss'],
})
export class ExportRegistrationCodeComponent implements OnInit {

  xmlTag = 'exportRegistrationCodeTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('exportRegistrationCodeTemp', {static: true, read: ViewContainerRef}) exportRegistrationCodeTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.exportRegistrationCodeTemp.createComponent(nodeComp);
