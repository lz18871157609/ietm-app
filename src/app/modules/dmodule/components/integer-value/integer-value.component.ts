...
export class IntegerValueComponent implements OnInit {
  ...
  xmlTag = 'integerValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('integerValueTemp', {static: true, read: ViewContainerRef}) integerValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.integerValueTemp.createComponent(nodeComp);
