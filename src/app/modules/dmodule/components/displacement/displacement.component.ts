...
export class DisplacementComponent implements OnInit {
  ...
  @ViewChild('displacementTemp', {static: true, read: ViewContainerRef}) displacementTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.displacementTemp.createComponent(nodeComp);
