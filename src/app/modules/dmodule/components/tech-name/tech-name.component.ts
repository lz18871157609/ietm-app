...
@Component({
  ...
  styleUrls: ['./tech-name.component.scss'],
...
export class TechNameComponent implements OnInit {
  ...
  @ViewChild('techNameTemp', {static: true, read: ViewContainerRef}) techNameTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.techNameTemp.createComponent(nodeComp);
