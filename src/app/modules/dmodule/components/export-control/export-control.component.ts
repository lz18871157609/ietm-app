...
export class ExportControlComponent implements OnInit {
  xmlTag = 'exportControlTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('exportControlTemp', {static: true, read: ViewContainerRef}) exportControlTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.exportControlTemp.createComponent(nodeComp);
