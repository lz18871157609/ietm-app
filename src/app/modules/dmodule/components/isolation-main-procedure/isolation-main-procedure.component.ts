...
@Component({
  selector: 'app-isolation-main-procedure',
  templateUrl: './isolation-main-procedure.component.html',
  styleUrls: ['./isolation-main-procedure.component.scss'],
})
export class IsolationMainProcedureComponent implements OnInit {

  xmlTag = 'isolationMainProcedureTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('isolationMainProcedureTemp', {static: true, read: ViewContainerRef}) isolationMainProcedureTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.isolationMainProcedureTemp.createComponent(nodeComp);
