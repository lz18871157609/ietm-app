...
@Component({
  selector: 'app-data-destruction',
  templateUrl: './data-destruction.component.html',
  styleUrls: ['./data-destruction.component.scss'],
})
export class DataDestructionComponent implements OnInit {
  xmlTag = 'dataDestructionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dataDestructionTemp', {static: true, read: ViewContainerRef}) dataDestructionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dataDestructionTemp.createComponent(nodeComp);
