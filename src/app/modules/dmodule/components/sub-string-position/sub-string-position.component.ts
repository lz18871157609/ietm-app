...
@Component({
  selector: 'app-sub-string-position',
  templateUrl: './sub-string-position.component.html',
  styleUrls: ['./sub-string-position.component.scss'],
})
export class SubStringPositionComponent implements OnInit {

xmlTag = 'subStringPositionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('subStringPositionTemp', {static: true, read: ViewContainerRef}) subStringPositionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.subStringPositionTemp.createComponent(nodeComp);
