...
@Component({
  selector: 'app-bit-message-alts',
  templateUrl: './bit-message-alts.component.html',
  styleUrls: ['./bit-message-alts.component.scss'],
})
export class BitMessageAltsComponent implements OnInit {
  xmlTag = 'bitMessageAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('bitMessageAltsTemp', {static: true, read: ViewContainerRef}) bitMessageAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.bitMessageAltsTemp.createComponent(nodeComp);
