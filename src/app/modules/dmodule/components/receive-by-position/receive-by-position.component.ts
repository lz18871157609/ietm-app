...
@Component({
  selector: 'app-receive-by-position',
  templateUrl: './receive-by-position.component.html',
  styleUrls: ['./receive-by-position.component.scss'],
})
export class ReceiveByPositionComponent implements OnInit {
  xmlTag = 'receiveByPositionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('receiveByPositionTemp', {static: true, read: ViewContainerRef}) receiveByPositionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.receiveByPositionTemp.createComponent(nodeComp);
