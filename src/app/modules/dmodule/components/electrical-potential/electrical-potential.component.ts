...
@Component({
  selector: 'app-electrical-potential',
  templateUrl: './electrical-potential.component.html',
  styleUrls: ['./electrical-potential.component.scss'],
})
export class ElectricalPotentialComponent implements OnInit {

  xmlTag = 'electricalPotentialTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('electricalPotentialTemp', {static: true, read: ViewContainerRef}) electricalPotentialTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.electricalPotentialTemp.createComponent(nodeComp);
