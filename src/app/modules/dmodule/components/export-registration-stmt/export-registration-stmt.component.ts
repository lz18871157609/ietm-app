...
@Component({
  selector: 'app-export-registration-stmt',
  templateUrl: './export-registration-stmt.component.html',
  styleUrls: ['./export-registration-stmt.component.scss'],
})
export class ExportRegistrationStmtComponent implements OnInit {
  xmlTag = 'exportRegistrationStmtTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('exportRegistrationStmtTemp', {static: true, read: ViewContainerRef}) exportRegistrationStmtTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.exportRegistrationStmtTemp.createComponent(nodeComp);
