...
@Component({
  ...
  styleUrls: ['./descr.component.scss'],
})
export class DescrComponent implements OnInit {
  xmlTag = 'descrTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('descrTemp', {static: true, read: ViewContainerRef}) descrTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.descrTemp.createComponent(nodeComp);
