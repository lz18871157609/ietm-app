...
@Component({
  selector: 'app-tech-standard',
  templateUrl: './tech-standard.component.html',
  styleUrls: ['./tech-standard.component.scss'],
})
export class TechStandardComponent implements OnInit {

  xmlTag = 'techStandardTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('techStandardTemp', {static: true, read: ViewContainerRef}) techStandardTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.techStandardTemp.createComponent(nodeComp);
