...
@Component({
  ...
  templateUrl: './authority-info.component.html',
  styleUrls: ['./authority-info.component.scss'],
})
export class AuthorityInfoComponent implements OnInit {
  xmlTag = 'authorityInfoTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('authorityInfoTemp', {static: true, read: ViewContainerRef}) authorityInfoTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.authorityInfoTemp.createComponent(nodeComp);
