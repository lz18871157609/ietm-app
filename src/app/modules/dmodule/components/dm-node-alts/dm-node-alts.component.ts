...
@Component({
  selector: 'app-dm-node-alts',
  templateUrl: './dm-node-alts.component.html',
  styleUrls: ['./dm-node-alts.component.scss'],
})
export class DmNodeAltsComponent implements OnInit {
  xmlTag = 'dmNodeAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmNodeAltsTemp', {static: true, read: ViewContainerRef}) dmNodeAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmNodeAltsTemp.createComponent(nodeComp);
