...
@Component({
  selector: 'app-procedural-step-alts',
  templateUrl: './procedural-step-alts.component.html',
  styleUrls: ['./procedural-step-alts.component.scss'],
})
export class ProceduralStepAltsComponent implements OnInit {
  xmlTag = 'proceduralStepAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('proceduralStepAltsTemp', {static: true, read: ViewContainerRef}) proceduralStepAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.proceduralStepAltsTemp.createComponent(nodeComp);
