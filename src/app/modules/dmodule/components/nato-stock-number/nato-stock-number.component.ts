...
@Component({
  selector: 'app-nato-stock-number',
  templateUrl: './nato-stock-number.component.html',
  styleUrls: ['./nato-stock-number.component.scss'],
})
export class NatoStockNumberComponent implements OnInit {
  xmlTag = 'natoStockNumberTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('natoStockNumberTemp', {static: true, read: ViewContainerRef}) natoStockNumberTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.natoStockNumberTemp.createComponent(nodeComp);
