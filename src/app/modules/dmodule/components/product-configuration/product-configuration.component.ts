...
export class ProductConfigurationComponent implements OnInit {
  xmlTag = 'productConfigurationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('productConfigurationTemp', {static: true, read: ViewContainerRef}) productConfigurationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.productConfigurationTemp.createComponent(nodeComp);
