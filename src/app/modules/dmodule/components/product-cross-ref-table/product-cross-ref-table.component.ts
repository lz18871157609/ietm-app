...
@Component({
  selector: 'app-product-cross-ref-table',
  templateUrl: './product-cross-ref-table.component.html',
  styleUrls: ['./product-cross-ref-table.component.scss'],
})
export class ProductCrossRefTableComponent implements OnInit {
  xmlTag = 'productCrossRefTableTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('productCrossRefTableTemp', {static: true, read: ViewContainerRef}) productCrossRefTableTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.productCrossRefTableTemp.createComponent(nodeComp);
