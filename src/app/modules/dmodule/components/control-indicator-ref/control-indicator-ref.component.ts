...
@Component({
  selector: 'app-control-indicator-ref',
  templateUrl: './control-indicator-ref.component.html',
  styleUrls: ['./control-indicator-ref.component.scss'],
})
export class ControlIndicatorRefComponent implements OnInit {

  xmlTag = 'controlIndicatorRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('controlIndicatorRefTemp', {static: true, read: ViewContainerRef}) controlIndicatorRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.controlIndicatorRefTemp.createComponent(nodeComp);
