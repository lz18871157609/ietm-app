...
@Component({
  selector: 'app-fault-message-body',
  templateUrl: './fault-message-body.component.html',
  styleUrls: ['./fault-message-body.component.scss'],
})
export class FaultMessageBodyComponent implements OnInit {
  xmlTag = 'faultMessageBodyTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultMessageBodyTemp', {static: true, read: ViewContainerRef}) faultMessageBodyTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultMessageBodyTemp.createComponent(nodeComp);
