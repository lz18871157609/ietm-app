...
@Component({
  selector: 'app-authority-notes',
  templateUrl: './authority-notes.component.html',
  styleUrls: ['./authority-notes.component.scss'],
})
export class AuthorityNotesComponent implements OnInit {
  xmlTag = 'authorityNotesTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('authorityNotesTemp', {static: true, read: ViewContainerRef}) authorityNotesTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.authorityNotesTemp.createComponent(nodeComp);
