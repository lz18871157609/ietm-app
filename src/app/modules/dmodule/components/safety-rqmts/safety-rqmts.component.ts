...
@Component({
  selector: 'app-safety-rqmts',
  templateUrl: './safety-rqmts.component.html',
  styleUrls: ['./safety-rqmts.component.scss'],
})
export class SafetyRqmtsComponent implements OnInit {
  xmlTag = 'safetyRqmtsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('safetyRqmtsTemp', {static: true, read: ViewContainerRef}) safetyRqmtsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.safetyRqmtsTemp.createComponent(nodeComp);
