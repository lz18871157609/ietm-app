...
@Component({
  selector: 'app-wire-number',
  templateUrl: './wire-number.component.html',
  styleUrls: ['./wire-number.component.scss'],
})
export class WireNumberComponent implements OnInit {
xmlTag = 'wireNumberTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('wireNumberTemp', {static: true, read: ViewContainerRef}) wireNumberTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.wireNumberTemp.createComponent(nodeComp);
