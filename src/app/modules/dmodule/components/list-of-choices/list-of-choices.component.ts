...
@Component({
  selector: 'app-list-of-choices',
  templateUrl: './list-of-choices.component.html',
  styleUrls: ['./list-of-choices.component.scss'],
})
export class ListOfChoicesComponent implements OnInit {

  xmlTag = 'listOfChoicesTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('listOfChoicesTemp', {static: true, read: ViewContainerRef}) listOfChoicesTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.listOfChoicesTemp.createComponent(nodeComp);
