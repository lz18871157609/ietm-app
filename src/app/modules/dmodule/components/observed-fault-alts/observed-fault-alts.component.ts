...
@Component({
  selector: 'app-observed-fault-alts',
  templateUrl: './observed-fault-alts.component.html',
  styleUrls: ['./observed-fault-alts.component.scss'],
})
export class ObservedFaultAltsComponent implements OnInit {
  xmlTag = 'observedFaultAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('observedFaultAltsTemp', {static: true, read: ViewContainerRef}) observedFaultAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.observedFaultAltsTemp.createComponent(nodeComp);
