...
@Component({
  selector: 'app-warning-malfunction-alts',
  templateUrl: './warning-malfunction-alts.component.html',
  styleUrls: ['./warning-malfunction-alts.component.scss'],
})
export class WarningMalfunctionAltsComponent implements OnInit {
xmlTag = 'warningMalfunctionAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('warningMalfunctionAltsTemp', {static: true, read: ViewContainerRef}) warningMalfunctionAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.warningMalfunctionAltsTemp.createComponent(nodeComp);
