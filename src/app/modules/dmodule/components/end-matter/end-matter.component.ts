...
@Component({
  selector: 'app-end-matter',
  templateUrl: './end-matter.component.html',
  styleUrls: ['./end-matter.component.scss'],
})
export class EndMatterComponent implements OnInit {
  xmlTag = 'endMatterTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('endMatterTemp', {static: true, read: ViewContainerRef}) endMatterTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.endMatterTemp.createComponent(nodeComp);
