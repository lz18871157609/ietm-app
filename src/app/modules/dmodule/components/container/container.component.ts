...
export class ContainerComponent implements OnInit {
  ...
  xmlTag = 'containerTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('containerTemp', {static: true, read: ViewContainerRef}) containerTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.containerTemp.createComponent(nodeComp);
