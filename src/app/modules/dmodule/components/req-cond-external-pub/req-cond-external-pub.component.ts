...
@Component({
  selector: 'app-req-cond-external-pub',
  templateUrl: './req-cond-external-pub.component.html',
  styleUrls: ['./req-cond-external-pub.component.scss'],
})
export class ReqCondExternalPubComponent implements OnInit {
  xmlTag = 'reqCondExternalPubTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqCondExternalPubTemp', {static: true, read: ViewContainerRef}) reqCondExternalPubTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqCondExternalPubTemp.createComponent(nodeComp);
