...
@Component({
  selector: 'app-caption-row',
  templateUrl: './caption-row.component.html',
  styleUrls: ['./caption-row.component.scss'],
})
export class CaptionRowComponent implements OnInit {
  xmlTag = 'captionRowTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('captionRowTemp', {static: true, read: ViewContainerRef}) captionRowTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.captionRowTemp.createComponent(nodeComp);
