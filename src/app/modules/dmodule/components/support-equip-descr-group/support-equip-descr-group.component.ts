...
@Component({
  selector: 'app-support-equip-descr-group',
  templateUrl: './support-equip-descr-group.component.html',
  styleUrls: ['./support-equip-descr-group.component.scss'],
})
export class SupportEquipDescrGroupComponent implements OnInit {

xmlTag = 'supportEquipDescrGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('supportEquipDescrGroupTemp', {static: true, read: ViewContainerRef}) supportEquipDescrGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.supportEquipDescrGroupTemp.createComponent(nodeComp);
