...
@Component({
  ...
  styleUrls: ['./task-definition.component.scss'],
})
export class TaskDefinitionComponent implements OnInit {

  xmlTag = 'taskDefinitionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('taskDefinitionTemp', {static: true, read: ViewContainerRef}) taskDefinitionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.taskDefinitionTemp.createComponent(nodeComp);
