...
@Component({
  selector: 'app-retrofit',
  templateUrl: './retrofit.component.html',
  styleUrls: ['./retrofit.component.scss'],
})
export class RetrofitComponent implements OnInit {
  xmlTag = 'retrofitTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('retrofitTemp', {static: true, read: ViewContainerRef}) retrofitTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.retrofitTemp.createComponent(nodeComp);
