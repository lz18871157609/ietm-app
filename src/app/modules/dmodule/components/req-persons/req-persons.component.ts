...
@Component({
  selector: 'app-req-persons',
  templateUrl: './req-persons.component.html',
  styleUrls: ['./req-persons.component.scss'],
})
export class ReqPersonsComponent implements OnInit {
  xmlTag = 'reqPersonsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqPersonsTemp', {static: true, read: ViewContainerRef}) reqPersonsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqPersonsTemp.createComponent(nodeComp);
