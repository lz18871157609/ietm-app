...
export class CheckListComponent implements OnInit {
  xmlTag = 'checkListTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('checkListTemp', {static: true, read: ViewContainerRef}) checkListTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.checkListTemp.createComponent(nodeComp);
