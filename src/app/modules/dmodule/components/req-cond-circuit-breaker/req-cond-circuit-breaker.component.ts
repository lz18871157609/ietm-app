...
@Component({
  selector: 'app-req-cond-circuit-breaker',
  templateUrl: './req-cond-circuit-breaker.component.html',
  styleUrls: ['./req-cond-circuit-breaker.component.scss'],
})
export class ReqCondCircuitBreakerComponent implements OnInit {
  xmlTag = 'reqCondCircuitBreakerTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqCondCircuitBreakerTemp', {static: true, read: ViewContainerRef}) reqCondCircuitBreakerTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqCondCircuitBreakerTemp.createComponent(nodeComp);
