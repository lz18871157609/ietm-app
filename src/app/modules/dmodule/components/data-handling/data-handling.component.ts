...
export class DataHandlingComponent implements OnInit {
  xmlTag = 'dataHandlingTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dataHandlingTemp', {static: true, read: ViewContainerRef}) dataHandlingTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dataHandlingTemp.createComponent(nodeComp);
