...
@Component({
  selector: 'app-external-pub-title',
  templateUrl: './external-pub-title.component.html',
  styleUrls: ['./external-pub-title.component.scss'],
})
export class ExternalPubTitleComponent implements OnInit {
  xmlTag = 'externalPubTitleTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('externalPubTitleTemp', {static: true, read: ViewContainerRef}) externalPubTitleTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.externalPubTitleTemp.createComponent(nodeComp);
