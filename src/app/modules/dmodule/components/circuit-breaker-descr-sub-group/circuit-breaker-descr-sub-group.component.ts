...
@Component({
  selector: 'app-circuit-breaker-descr-sub-group',
  templateUrl: './circuit-breaker-descr-sub-group.component.html',
  styleUrls: ['./circuit-breaker-descr-sub-group.component.scss'],
})
export class CircuitBreakerDescrSubGroupComponent implements OnInit {
  xmlTag = 'circuitBreakerDescrSubGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('circuitBreakerDescrSubGroupTemp', {static: true, read: ViewContainerRef}) circuitBreakerDescrSubGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.circuitBreakerDescrSubGroupTemp.createComponent(nodeComp);
