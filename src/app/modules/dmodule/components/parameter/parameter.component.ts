...
export class ParameterComponent implements OnInit {
  xmlTag = 'parameterTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('parameterTemp', {static: true, read: ViewContainerRef}) parameterTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.parameterTemp.createComponent(nodeComp);
