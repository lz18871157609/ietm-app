...
@Component({
  selector: 'app-authority-exceptions',
  templateUrl: './authority-exceptions.component.html',
  styleUrls: ['./authority-exceptions.component.scss'],
})
export class AuthorityExceptionsComponent implements OnInit {
  xmlTag = 'authorityExceptionsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('authorityExceptionsTemp', {static: true, read: ViewContainerRef}) authorityExceptionsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.authorityExceptionsTemp.createComponent(nodeComp);
