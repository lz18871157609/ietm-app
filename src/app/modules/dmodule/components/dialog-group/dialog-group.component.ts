...
export class DialogGroupComponent implements OnInit {
  xmlTag = 'dialogGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dialogGroupTemp', {static: true, read: ViewContainerRef}) dialogGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dialogGroupTemp.createComponent(nodeComp);
