...
@Component({
  selector: 'app-locate-and-repair-sru-item',
  templateUrl: './locate-and-repair-sru-item.component.html',
  styleUrls: ['./locate-and-repair-sru-item.component.scss'],
})
export class LocateAndRepairSruItemComponent implements OnInit {

  xmlTag = 'locateAndRepairSruItemTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('locateAndRepairSruItemTemp', {static: true, read: ViewContainerRef}) locateAndRepairSruItemTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.locateAndRepairSruItemTemp.createComponent(nodeComp);
