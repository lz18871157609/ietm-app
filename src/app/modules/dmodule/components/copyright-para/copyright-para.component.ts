...
@Component({
  selector: 'app-copyright-para',
  templateUrl: './copyright-para.component.html',
  styleUrls: ['./copyright-para.component.scss'],
})
export class CopyrightParaComponent implements OnInit {

  xmlTag = 'copyrightParaTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('copyrightParaTemp', {static: true, read: ViewContainerRef}) copyrightParaTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.copyrightParaTemp.createComponent(nodeComp);
