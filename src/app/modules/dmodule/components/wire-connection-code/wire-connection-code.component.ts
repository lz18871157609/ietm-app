...
@Component({
  selector: 'app-wire-connection-code',
  templateUrl: './wire-connection-code.component.html',
  styleUrls: ['./wire-connection-code.component.scss'],
})
export class WireConnectionCodeComponent implements OnInit {
xmlTag = 'wireConnectionCodeTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('wireConnectionCodeTemp', {static: true, read: ViewContainerRef}) wireConnectionCodeTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.wireConnectionCodeTemp.createComponent(nodeComp);
