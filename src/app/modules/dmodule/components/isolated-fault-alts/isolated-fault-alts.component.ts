...
@Component({
  selector: 'app-isolated-fault-alts',
  templateUrl: './isolated-fault-alts.component.html',
  styleUrls: ['./isolated-fault-alts.component.scss'],
})
export class IsolatedFaultAltsComponent implements OnInit {

  xmlTag = 'isolatedFaultAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('isolatedFaultAltsTemp', {static: true, read: ViewContainerRef}) isolatedFaultAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.isolatedFaultAltsTemp.createComponent(nodeComp);
