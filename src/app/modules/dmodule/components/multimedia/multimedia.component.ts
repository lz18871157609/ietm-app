...
export class MultimediaComponent implements OnInit {
  ...
  xmlTag = 'multimediaTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('multimediaTemp', {static: true, read: ViewContainerRef}) multimediaTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.multimediaTemp.createComponent(nodeComp);
