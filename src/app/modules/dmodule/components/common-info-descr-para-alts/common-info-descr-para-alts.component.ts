...
@Component({
  selector: 'app-common-info-descr-para-alts',
  templateUrl: './common-info-descr-para-alts.component.html',
  styleUrls: ['./common-info-descr-para-alts.component.scss'],
})
export class CommonInfoDescrParaAltsComponent implements OnInit {

  xmlTag = 'commonInfoDescrParaAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('commonInfoDescrParaAltsTemp', {static: true, read: ViewContainerRef}) commonInfoDescrParaAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.commonInfoDescrParaAltsTemp.createComponent(nodeComp);
