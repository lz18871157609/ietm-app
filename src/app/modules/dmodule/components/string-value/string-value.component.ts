...
xmlTag = 'stringValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('stringValueTemp', {static: true, read: ViewContainerRef}) stringValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.stringValueTemp.createComponent(nodeComp);
