...
@Component({
  selector: 'app-yes-no-answer',
  templateUrl: './yes-no-answer.component.html',
  styleUrls: ['./yes-no-answer.component.scss'],
})
export class YesNoAnswerComponent implements OnInit {
xmlTag = 'yesNoAnswerTempTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('yesNoAnswerTempTemp', {static: true, read: ViewContainerRef}) yesNoAnswerTempTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.yesNoAnswerTempTemp.createComponent(nodeComp);
