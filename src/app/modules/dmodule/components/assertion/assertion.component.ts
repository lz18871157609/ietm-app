...
export class AssertionComponent implements OnInit {
  xmlTag = 'assertionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('assertionTemp', {static: true, read: ViewContainerRef}) assertionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.assertionTemp.createComponent(nodeComp);
