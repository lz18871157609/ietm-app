...
@Component({
  selector: 'app-lru-item',
  templateUrl: './lru-item.component.html',
  styleUrls: ['./lru-item.component.scss'],
})
export class LruItemComponent implements OnInit {

  xmlTag = 'lruItemTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('lruItemTemp', {static: true, read: ViewContainerRef}) lruItemTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.lruItemTemp.createComponent(nodeComp);
