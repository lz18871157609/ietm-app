...
@Component({
  selector: 'app-installation-location',
  templateUrl: './installation-location.component.html',
  styleUrls: ['./installation-location.component.scss'],
})
export class InstallationLocationComponent implements OnInit {

  xmlTag = 'installationLocationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('installationLocationTemp', {static: true, read: ViewContainerRef}) installationLocationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.installationLocationTemp.createComponent(nodeComp);
