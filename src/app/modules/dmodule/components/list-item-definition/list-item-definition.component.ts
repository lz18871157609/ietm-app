...
@Component({
  selector: 'app-list-item-definition',
  templateUrl: './list-item-definition.component.html',
  styleUrls: ['./list-item-definition.component.scss'],
})
export class ListItemDefinitionComponent implements OnInit {

  xmlTag = 'listItemDefinitionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('listItemDefinitionTemp', {static: true, read: ViewContainerRef}) listItemDefinitionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.listItemDefinitionTemp.createComponent(nodeComp);
