...
@Component({
  selector: 'app-supply-rqmt-ref',
  templateUrl: './supply-rqmt-ref.component.html',
  styleUrls: ['./supply-rqmt-ref.component.scss'],
})
export class SupplyRqmtRefComponent implements OnInit {

xmlTag = 'supplyRqmtRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('supplyRqmtRefTemp', {static: true, read: ViewContainerRef}) supplyRqmtRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.supplyRqmtRefTemp.createComponent(nodeComp);
