...
export class ProductItemComponent implements OnInit {
  xmlTag = 'productItemTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('productItemTemp', {static: true, read: ViewContainerRef}) productItemTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.productItemTemp.createComponent(nodeComp);
