...
@Component({
  selector: 'app-dm-ref-address-items',
  templateUrl: './dm-ref-address-items.component.html',
  styleUrls: ['./dm-ref-address-items.component.scss'],
  providers: [DynamicDmComponentService]
})
export class DmRefAddressItemsComponent implements OnInit {
  xmlTag = 'action';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmRefAddressItemsTemp', {static: true, read: ViewContainerRef}) dmRefAddressItemsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmRefAddressItemsTemp.createComponent(nodeComp);
