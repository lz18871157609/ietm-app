...
@Component({
  ...
  styleUrls: ['./fault-reporting.component.scss'],
})
export class FaultReportingComponent implements OnInit {
  xmlTag = 'faultReportingTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultReportingTemp', {static: true, read: ViewContainerRef}) faultReportingTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultReportingTemp.createComponent(nodeComp);
