...
@Component({
  selector: 'app-descr-description',
  templateUrl: './descr-description.component.html',
  styleUrls: ['./descr-description.component.scss'],
})
export class DescrDescriptionComponent implements OnInit {
  xmlTag = 'descrDescriptionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('descrDescriptionTemp', {static: true, read: ViewContainerRef}) descrDescriptionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.descrDescriptionTemp.createComponent(nodeComp);
