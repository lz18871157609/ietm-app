...
@Component({
  selector: 'app-pm-ref-address-items',
  templateUrl: './pm-ref-address-items.component.html',
  styleUrls: ['./pm-ref-address-items.component.scss'],
})
export class PmRefAddressItemsComponent implements OnInit {
  xmlTag = 'pmRefAddressItemsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('pmRefAddressItemsTemp', {static: true, read: ViewContainerRef}) pmRefAddressItemsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.pmRefAddressItemsTemp.createComponent(nodeComp);
