...
@Component({
  selector: 'app-embedded-support-equip-descr',
  templateUrl: './embedded-support-equip-descr.component.html',
  styleUrls: ['./embedded-support-equip-descr.component.scss'],
})
export class EmbeddedSupportEquipDescrComponent implements OnInit {

  xmlTag = 'embeddedSupportEquipDescrTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('embeddedSupportEquipDescrTemp', {static: true, read: ViewContainerRef}) embeddedSupportEquipDescrTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.embeddedSupportEquipDescrTemp.createComponent(nodeComp);
