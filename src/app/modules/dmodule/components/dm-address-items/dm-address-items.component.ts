...
@Component({
  selector: 'app-dm-address-items',
  templateUrl: './dm-address-items.component.html',
  styleUrls: ['./dm-address-items.component.scss'],
})
export class DmAddressItemsComponent implements OnInit {
  xmlTag = 'dmAddressItemsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmAddressItemsTemp', {static: true, read: ViewContainerRef}) dmAddressItemsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmAddressItemsTemp.createComponent(nodeComp);
