...
@Component({
  selector: 'app-responsible-partner-company',
  templateUrl: './responsible-partner-company.component.html',
  styleUrls: ['./responsible-partner-company.component.scss'],
})
export class ResponsiblePartnerCompanyComponent implements OnInit {
  xmlTag = 'responsiblePartnerCompanyTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('responsiblePartnerCompanyTemp', {static: true, read: ViewContainerRef}) responsiblePartnerCompanyTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.responsiblePartnerCompanyTemp.createComponent(nodeComp);
