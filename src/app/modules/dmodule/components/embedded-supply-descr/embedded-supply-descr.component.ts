...
@Component({
  selector: 'app-embedded-supply-descr',
  templateUrl: './embedded-supply-descr.component.html',
  styleUrls: ['./embedded-supply-descr.component.scss'],
})
export class EmbeddedSupplyDescrComponent implements OnInit {
  xmlTag = 'embeddedSupplyDescrTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('embeddedSupplyDescrTemp', {static: true, read: ViewContainerRef}) embeddedSupplyDescrTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.embeddedSupplyDescrTemp.createComponent(nodeComp);
