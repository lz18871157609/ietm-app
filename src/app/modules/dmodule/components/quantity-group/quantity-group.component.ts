...
@Component({
  selector: 'app-quantity-group',
  templateUrl: './quantity-group.component.html',
  styleUrls: ['./quantity-group.component.scss'],
})
export class QuantityGroupComponent implements OnInit {
  xmlTag = 'quantityGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('quantityGroupTemp', {static: true, read: ViewContainerRef}) quantityGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.quantityGroupTemp.createComponent(nodeComp);
