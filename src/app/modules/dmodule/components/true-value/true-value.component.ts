...
@Component({
  selector: 'app-true-value',
  templateUrl: './true-value.component.html',
  styleUrls: ['./true-value.component.scss'],
})
export class TrueValueComponent implements OnInit {

  xmlTag = 'trueValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('trueValueTemp', {static: true, read: ViewContainerRef}) trueValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.trueValueTemp.createComponent(nodeComp);
