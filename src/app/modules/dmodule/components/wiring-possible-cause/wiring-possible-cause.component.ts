...
@Component({
  selector: 'app-wiring-possible-cause',
  templateUrl: './wiring-possible-cause.component.html',
  styleUrls: ['./wiring-possible-cause.component.scss'],
})
export class WiringPossibleCauseComponent implements OnInit {
xmlTag = 'wiringPossibleCauseTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('wiringPossibleCauseTemp', {static: true, read: ViewContainerRef}) wiringPossibleCauseTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.wiringPossibleCauseTemp.createComponent(nodeComp);
