...
export class PartNumberComponent implements OnInit {
  xmlTag = 'partNumberTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('partNumberTemp', {static: true, read: ViewContainerRef}) partNumberTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.partNumberTemp.createComponent(nodeComp);
