...
export class PushButtonComponent implements OnInit {
  xmlTag = 'pushButtonTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('pushButtonTemp', {static: true, read: ViewContainerRef}) pushButtonTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.pushButtonTemp.createComponent(nodeComp);
