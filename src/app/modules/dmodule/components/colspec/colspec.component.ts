...
@Component({
  selector: 'app-colspec',
  templateUrl: './colspec.component.html',
  styleUrls: ['./colspec.component.scss'],
})
export class ColspecComponent implements OnInit {
  xmlTag = 'colspecTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('colspecTemp', {static: true, read: ViewContainerRef}) colspecTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.colspecTemp.createComponent(nodeComp);
