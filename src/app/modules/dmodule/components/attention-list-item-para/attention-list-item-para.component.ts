...
@Component({
  selector: 'app-attention-list-item-para',
  templateUrl: './attention-list-item-para.component.html',
  styleUrls: ['./attention-list-item-para.component.scss'],
})
export class AttentionListItemParaComponent implements OnInit {
  xmlTag = 'attentionListItemTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('attentionListItemTemp', {static: true, read: ViewContainerRef}) attentionListItemTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.attentionListItemTemp.createComponent(nodeComp);
