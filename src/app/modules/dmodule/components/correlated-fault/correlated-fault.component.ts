...
@Component({
  selector: 'app-correlated-fault',
  templateUrl: './correlated-fault.component.html',
  styleUrls: ['./correlated-fault.component.scss'],
})
export class CorrelatedFaultComponent implements OnInit {

  xmlTag = 'correlatedFaultTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('correlatedFaultTemp', {static: true, read: ViewContainerRef}) correlatedFaultTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.correlatedFaultTemp.createComponent(nodeComp);
