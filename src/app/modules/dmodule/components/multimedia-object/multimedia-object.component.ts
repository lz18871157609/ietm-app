...
@Component({
  selector: 'app-multimedia-object',
  templateUrl: './multimedia-object.component.html',
  styleUrls: ['./multimedia-object.component.scss'],
})
export class MultimediaObjectComponent implements OnInit {


  xmlTag = 'multimediaObjectTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('multimediaObjectTemp', {static: true, read: ViewContainerRef}) multimediaObjectTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.multimediaObjectTemp.createComponent(nodeComp);
