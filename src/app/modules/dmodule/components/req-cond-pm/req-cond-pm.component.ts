...
@Component({
  selector: 'app-req-cond-pm',
  templateUrl: './req-cond-pm.component.html',
  styleUrls: ['./req-cond-pm.component.scss'],
})
export class ReqCondPmComponent implements OnInit {
  xmlTag = 'reqCondPmTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqCondPmTemp', {static: true, read: ViewContainerRef}) reqCondPmTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqCondPmTemp.createComponent(nodeComp);
