...
@Component({
  selector: 'app-product-safety',
  templateUrl: './product-safety.component.html',
  styleUrls: ['./product-safety.component.scss'],
})
export class ProductSafetyComponent implements OnInit {
  xmlTag = 'productSafetyTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('productSafetyTemp', {static: true, read: ViewContainerRef}) productSafetyTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.productSafetyTemp.createComponent(nodeComp);
