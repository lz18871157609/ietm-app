...
@Component({
  selector: 'app-brex',
  templateUrl: './brex.component.html',
  styleUrls: ['./brex.component.scss'],
})
export class BrexComponent implements OnInit {
  xmlTag = 'brexTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('brexTemp', {static: true, read: ViewContainerRef}) brexTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.brexTemp.createComponent(nodeComp);
