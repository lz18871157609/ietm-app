...
@Component({
  selector: 'app-initial-provisioning-project',
  templateUrl: './initial-provisioning-project.component.html',
  styleUrls: ['./initial-provisioning-project.component.scss'],
})
export class InitialProvisioningProjectComponent implements OnInit {

  xmlTag = 'initialProvisioningProjectTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('initialProvisioningProjectTemp', {static: true, read: ViewContainerRef}) initialProvisioningProjectTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.initialProvisioningProjectTemp.createComponent(nodeComp);
