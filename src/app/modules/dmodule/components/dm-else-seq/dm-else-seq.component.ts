...
@Component({
  selector: 'app-dm-else-seq',
  templateUrl: './dm-else-seq.component.html',
  styleUrls: ['./dm-else-seq.component.scss'],
})
export class DmElseSeqComponent implements OnInit {
  xmlTag = 'dmElseSeqTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmElseSeqTemp', {static: true, read: ViewContainerRef}) dmElseSeqTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmElseSeqTemp.createComponent(nodeComp);
