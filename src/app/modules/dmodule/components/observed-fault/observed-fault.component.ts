...
@Component({
  selector: 'app-observed-fault',
  templateUrl: './observed-fault.component.html',
  styleUrls: ['./observed-fault.component.scss'],
})
export class ObservedFaultComponent implements OnInit {

  xmlTag = 'observedFaultTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('observedFaultTemp', {static: true, read: ViewContainerRef}) observedFaultTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.observedFaultTemp.createComponent(nodeComp);
