...
@Component({
  ...
  styleUrls: ['./applic.component.scss'],
...
export class ApplicComponent implements OnInit {
  ...
  @ViewChild('applicTemp', {static: true, read: ViewContainerRef}) applicTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.applicTemp.createComponent(nodeComp);
