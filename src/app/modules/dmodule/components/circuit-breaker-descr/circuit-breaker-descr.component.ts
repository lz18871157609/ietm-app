...
@Component({
  selector: 'app-circuit-breaker-descr',
  templateUrl: './circuit-breaker-descr.component.html',
  styleUrls: ['./circuit-breaker-descr.component.scss'],
})
export class CircuitBreakerDescrComponent implements OnInit {

  xmlTag = 'circuitBreakerDescrTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('circuitBreakerDescrTemp', {static: true, read: ViewContainerRef}) circuitBreakerDescrTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.circuitBreakerDescrTemp.createComponent(nodeComp);
