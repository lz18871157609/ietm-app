...
@Component({
  selector: 'app-dm-address',
  templateUrl: './dm-address.component.html',
  styleUrls: ['./dm-address.component.scss'],
})
export class DmAddressComponent implements OnInit {
  xmlTag = 'dmAddressTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmAddressTemp', {static: true, read: ViewContainerRef}) dmAddressTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmAddressTemp.createComponent(nodeComp);
