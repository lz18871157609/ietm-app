...
@Component({
  selector: 'app-crew-member-group',
  templateUrl: './crew-member-group.component.html',
  styleUrls: ['./crew-member-group.component.scss'],
})
export class CrewMemberGroupComponent implements OnInit {

  xmlTag = 'crewMemberGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('crewMemberGroupTemp', {static: true, read: ViewContainerRef}) crewMemberGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.crewMemberGroupTemp.createComponent(nodeComp);
