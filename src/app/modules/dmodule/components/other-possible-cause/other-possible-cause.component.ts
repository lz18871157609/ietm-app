...
@Component({
  selector: 'app-other-possible-cause',
  templateUrl: './other-possible-cause.component.html',
  styleUrls: ['./other-possible-cause.component.scss'],
})
export class OtherPossibleCauseComponent implements OnInit {

  xmlTag = 'otherPossibleCauseTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('otherPossibleCauseTemp', {static: true, read: ViewContainerRef}) otherPossibleCauseTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.otherPossibleCauseTemp.createComponent(nodeComp);
