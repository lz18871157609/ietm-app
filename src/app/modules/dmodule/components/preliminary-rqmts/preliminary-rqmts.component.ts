...
@Component({
  selector: 'app-preliminary-rqmts',
  templateUrl: './preliminary-rqmts.component.html',
  styleUrls: ['./preliminary-rqmts.component.scss'],
})
export class PreliminaryRqmtsComponent implements OnInit {
  xmlTag = 'preliminaryRqmtsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('preliminaryRqmtsTemp', {static: true, read: ViewContainerRef}) preliminaryRqmtsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.preliminaryRqmtsTemp.createComponent(nodeComp);
