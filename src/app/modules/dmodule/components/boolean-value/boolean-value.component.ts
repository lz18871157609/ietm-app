...
export class BooleanValueComponent implements OnInit {
  xmlTag = 'booleanValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('booleanValueTemp', {static: true, read: ViewContainerRef}) booleanValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.booleanValueTemp.createComponent(nodeComp);
