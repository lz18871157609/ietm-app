...
@Component({
  selector: 'app-fault-isolation-procedure',
  templateUrl: './fault-isolation-procedure.component.html',
  styleUrls: ['./fault-isolation-procedure.component.scss'],
})
export class FaultIsolationProcedureComponent implements OnInit {
  xmlTag = 'faultIsolationProcedureTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultIsolationProcedureTemp', {static: true, read: ViewContainerRef}) faultIsolationProcedureTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultIsolationProcedureTemp.createComponent(nodeComp);
