...
@Component({
  ...
  styleUrls: ['./test-procedure.component.scss'],
})
export class TestProcedureComponent implements OnInit {

  xmlTag = 'testProcedureTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('testProcedureTemp', {static: true, read: ViewContainerRef}) testProcedureTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.testProcedureTemp.createComponent(nodeComp);
