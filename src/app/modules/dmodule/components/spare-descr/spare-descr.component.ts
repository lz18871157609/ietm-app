...
@Component({
  selector: 'app-spare-descr',
  templateUrl: './spare-descr.component.html',
  styleUrls: ['./spare-descr.component.scss'],
})
export class SpareDescrComponent implements OnInit {

xmlTag = 'spareDescrTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('spareDescrTemp', {static: true, read: ViewContainerRef}) spareDescrTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.spareDescrTemp.createComponent(nodeComp);
