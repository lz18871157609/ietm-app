...
@Component({
  selector: 'app-warning-malfunction',
  templateUrl: './warning-malfunction.component.html',
  styleUrls: ['./warning-malfunction.component.scss'],
})
export class WarningMalfunctionComponent implements OnInit {
xmlTag = 'warningMalfunctionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('warningMalfunctionTemp', {static: true, read: ViewContainerRef}) warningMalfunctionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.warningMalfunctionTemp.createComponent(nodeComp);
