...
@Component({
  selector: 'app-req-cond-no-ref',
  templateUrl: './req-cond-no-ref.component.html',
  styleUrls: ['./req-cond-no-ref.component.scss'],
})
export class ReqCondNoRefComponent implements OnInit {
  xmlTag = 'reqCondNoRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqCondNoRefTemp', {static: true, read: ViewContainerRef}) reqCondNoRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqCondNoRefTemp.createComponent(nodeComp);
