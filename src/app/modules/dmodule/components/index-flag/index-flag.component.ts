...
@Component({
  selector: 'app-index-flag',
  templateUrl: './index-flag.component.html',
  styleUrls: ['./index-flag.component.scss'],
})
export class IndexFlagComponent implements OnInit {

  xmlTag = 'indexFlagTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('indexFlagTemp', {static: true, read: ViewContainerRef}) indexFlagTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.indexFlagTemp.createComponent(nodeComp);
