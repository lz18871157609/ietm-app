...
@Component({
  selector: 'app-fault-cond',
  templateUrl: './fault-cond.component.html',
  styleUrls: ['./fault-cond.component.scss'],
})
export class FaultCondComponent implements OnInit {
  xmlTag = 'faultCondTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultCondTemp', {static: true, read: ViewContainerRef}) faultCondTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultCondTemp.createComponent(nodeComp);
