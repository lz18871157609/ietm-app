...
@Component({
  selector: 'app-supersedure',
  templateUrl: './supersedure.component.html',
  styleUrls: ['./supersedure.component.scss'],
})
export class SupersedureComponent implements OnInit {

xmlTag = 'supersedureTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('supersedureTemp', {static: true, read: ViewContainerRef}) supersedureTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.supersedureTemp.createComponent(nodeComp);
