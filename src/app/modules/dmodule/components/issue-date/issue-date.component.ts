...
@Component({
  ...
  styleUrls: ['./issue-date.component.scss'],
...
export class IssueDateComponent implements OnInit {
  ...
  @ViewChild('issueDateTemp', {static: true, read: ViewContainerRef}) issueDateTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.issueDateTemp.createComponent(nodeComp);
