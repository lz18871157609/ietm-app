...
@Component({
  selector: 'app-system-breakdown-code',
  templateUrl: './system-breakdown-code.component.html',
  styleUrls: ['./system-breakdown-code.component.scss'],
})
export class SystemBreakdownCodeComponent implements OnInit {

xmlTag = 'systemBreakdownCodeTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('systemBreakdownCodeTemp', {static: true, read: ViewContainerRef}) systemBreakdownCodeTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.systemBreakdownCodeTemp.createComponent(nodeComp);
