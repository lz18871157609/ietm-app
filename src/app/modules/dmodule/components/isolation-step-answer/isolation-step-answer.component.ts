...
@Component({
  selector: 'app-isolation-step-answer',
  templateUrl: './isolation-step-answer.component.html',
  styleUrls: ['./isolation-step-answer.component.scss'],
})
export class IsolationStepAnswerComponent implements OnInit {


  xmlTag = 'isolationStepAnswerTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('isolationStepAnswerTemp', {static: true, read: ViewContainerRef}) isolationStepAnswerTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.isolationStepAnswerTemp.createComponent(nodeComp);
