...
@Component({
  selector: 'app-circuit-breaker-descr-group',
  templateUrl: './circuit-breaker-descr-group.component.html',
  styleUrls: ['./circuit-breaker-descr-group.component.scss'],
})
export class CircuitBreakerDescrGroupComponent implements OnInit {
  xmlTag = 'circuitBreakerDescrGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('circuitBreakerDescrGroupTemp', {static: true, read: ViewContainerRef}) circuitBreakerDescrGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.circuitBreakerDescrGroupTemp.createComponent(nodeComp);
