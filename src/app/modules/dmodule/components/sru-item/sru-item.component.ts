...
@Component({
  selector: 'app-sru-item',
  templateUrl: './sru-item.component.html',
  styleUrls: ['./sru-item.component.scss'],
})
export class SruItemComponent implements OnInit {

xmlTag = 'sruItemTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('sruItemTemp', {static: true, read: ViewContainerRef}) sruItemTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.sruItemTemp.createComponent(nodeComp);
