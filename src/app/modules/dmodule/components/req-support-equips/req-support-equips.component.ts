...
@Component({
  selector: 'app-req-support-equips',
  templateUrl: './req-support-equips.component.html',
  styleUrls: ['./req-support-equips.component.scss'],
})
export class ReqSupportEquipsComponent implements OnInit {
  xmlTag = 'reqSupportEquipsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqSupportEquipsTemp', {static: true, read: ViewContainerRef}) reqSupportEquipsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqSupportEquipsTemp.createComponent(nodeComp);
