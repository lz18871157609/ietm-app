...
@Component({
  selector: 'app-ident-number',
  templateUrl: './ident-number.component.html',
  styleUrls: ['./ident-number.component.scss'],
})
export class IdentNumberComponent implements OnInit {

  xmlTag = 'identNumberTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('identNumberTemp', {static: true, read: ViewContainerRef}) identNumberTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.identNumberTemp.createComponent(nodeComp);
