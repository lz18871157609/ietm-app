...
@Component({
  selector: 'app-isolation-procedure-end',
  templateUrl: './isolation-procedure-end.component.html',
  styleUrls: ['./isolation-procedure-end.component.scss'],
})
export class IsolationProcedureEndComponent implements OnInit {


  xmlTag = 'isolationProcedureEndTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('isolationProcedureEndTemp', {static: true, read: ViewContainerRef}) isolationProcedureEndTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.isolationProcedureEndTemp.createComponent(nodeComp);
