...
@Component({
  selector: 'app-dm-seq',
  templateUrl: './dm-seq.component.html',
  styleUrls: ['./dm-seq.component.scss'],
})
export class DmSeqComponent implements OnInit {
  xmlTag = 'dmSeqTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmSeqTemp', {static: true, read: ViewContainerRef}) dmSeqTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmSeqTemp.createComponent(nodeComp);
