...
@Component({
  selector: 'app-quantity-tolerance',
  templateUrl: './quantity-tolerance.component.html',
  styleUrls: ['./quantity-tolerance.component.scss'],
})
export class QuantityToleranceComponent implements OnInit {
  xmlTag = 'quantityToleranceTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('quantityToleranceTemp', {static: true, read: ViewContainerRef}) quantityToleranceTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.quantityToleranceTemp.createComponent(nodeComp);
