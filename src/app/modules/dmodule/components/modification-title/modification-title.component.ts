...
@Component({
  selector: 'app-modification-title',
  templateUrl: './modification-title.component.html',
  styleUrls: ['./modification-title.component.scss'],
})
export class ModificationTitleComponent implements OnInit {

  xmlTag = 'modificationAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('modificationAltsTemp', {static: true, read: ViewContainerRef}) modificationAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.modificationAltsTemp.createComponent(nodeComp);
