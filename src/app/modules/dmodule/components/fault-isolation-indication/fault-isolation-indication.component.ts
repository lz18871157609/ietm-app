...
@Component({
  selector: 'app-fault-isolation-indication',
  templateUrl: './fault-isolation-indication.component.html',
  styleUrls: ['./fault-isolation-indication.component.scss'],
})
export class FaultIsolationIndicationComponent implements OnInit {
  xmlTag = 'faultIsolationIndicationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultIsolationIndicationTemp', {static: true, read: ViewContainerRef}) faultIsolationIndicationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultIsolationIndicationTemp.createComponent(nodeComp);
