...
@Component({
  selector: 'app-isolation-procedure-end-alts',
  templateUrl: './isolation-procedure-end-alts.component.html',
  styleUrls: ['./isolation-procedure-end-alts.component.scss'],
})
export class IsolationProcedureEndAltsComponent implements OnInit {


  xmlTag = 'isolationProcedureEndAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('isolationProcedureEndAltsTemp', {static: true, read: ViewContainerRef}) isolationProcedureEndAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.isolationProcedureEndAltsTemp.createComponent(nodeComp);
