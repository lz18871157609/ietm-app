...
@Component({
  selector: 'app-isolation-procedure',
  templateUrl: './isolation-procedure.component.html',
  styleUrls: ['./isolation-procedure.component.scss'],
})
export class IsolationProcedureComponent implements OnInit {

 
  xmlTag = 'isolationProcedureTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('isolationProcedureTemp', {static: true, read: ViewContainerRef}) isolationProcedureTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.isolationProcedureTemp.createComponent(nodeComp);
