...
@Component({
  selector: 'app-dm-ref-ident',
  templateUrl: './dm-ref-ident.component.html',
  styleUrls: ['./dm-ref-ident.component.scss'],
  providers: [DynamicDmComponentService]
})
export class DmRefIdentComponent implements OnInit {
  xmlTag = 'action';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmRefIdentTemp', {static: true, read: ViewContainerRef}) dmRefIdentTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmRefIdentTemp.createComponent(nodeComp);
