...
@Component({
  selector: 'app-para-basic',
  templateUrl: './para-basic.component.html',
  styleUrls: ['./para-basic.component.scss'],
})
export class ParaBasicComponent implements OnInit {
  xmlTag = 'paraBasicTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('paraBasicTemp', {static: true, read: ViewContainerRef}) paraBasicTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.paraBasicTemp.createComponent(nodeComp);
