...
@Component({
  selector: 'app-ident-extension',
  templateUrl: './ident-extension.component.html',
  styleUrls: ['./ident-extension.component.scss'],
})
export class IdentExtensionComponent implements OnInit {

  
  xmlTag = 'identExtensionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('identExtensionTemp', {static: true, read: ViewContainerRef}) identExtensionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.identExtensionTemp.createComponent(nodeComp);
