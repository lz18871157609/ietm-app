...
@Component({
  selector: 'app-fault-context',
  templateUrl: './fault-context.component.html',
  styleUrls: ['./fault-context.component.scss'],
})
export class FaultContextComponent implements OnInit {
  xmlTag = 'faultContextTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultContextTemp', {static: true, read: ViewContainerRef}) faultContextTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultContextTemp.createComponent(nodeComp);
