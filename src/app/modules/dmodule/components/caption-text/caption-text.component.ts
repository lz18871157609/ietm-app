...
export class CaptionTextComponent implements OnInit {
  xmlTag = 'captionTextTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('captionTextTemp', {static: true, read: ViewContainerRef}) captionTextTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.captionTextTemp.createComponent(nodeComp);
