...
@Component({
  selector: 'app-warning-and-cautions',
  templateUrl: './warning-and-cautions.component.html',
  styleUrls: ['./warning-and-cautions.component.scss'],
})
export class WarningAndCautionsComponent implements OnInit {
xmlTag = 'warningAndCautionsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('warningAndCautionsTemp', {static: true, read: ViewContainerRef}) warningAndCautionsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.warningAndCautionsTemp.createComponent(nodeComp);
