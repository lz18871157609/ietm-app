...
@Component({
  selector: 'app-material-set-ref',
  templateUrl: './material-set-ref.component.html',
  styleUrls: ['./material-set-ref.component.scss'],
})
export class MaterialSetRefComponent implements OnInit {

  xmlTag = 'materialSetRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('materialSetRefTemp', {static: true, read: ViewContainerRef}) materialSetRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.materialSetRefTemp.createComponent(nodeComp);
