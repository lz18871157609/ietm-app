...
@Component({
  selector: 'app-manufacturer-code',
  templateUrl: './manufacturer-code.component.html',
  styleUrls: ['./manufacturer-code.component.scss'],
})
export class ManufacturerCodeComponent implements OnInit {

  xmlTag = 'manufacturerCodeTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('manufacturerCodeTemp', {static: true, read: ViewContainerRef}) manufacturerCodeTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.manufacturerCodeTemp.createComponent(nodeComp);
