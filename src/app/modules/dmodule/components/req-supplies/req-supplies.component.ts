...
@Component({
  selector: 'app-req-supplies',
  templateUrl: './req-supplies.component.html',
  styleUrls: ['./req-supplies.component.scss'],
})
export class ReqSuppliesComponent implements OnInit {
  xmlTag = 'reqSuppliesTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqSuppliesTemp', {static: true, read: ViewContainerRef}) reqSuppliesTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqSuppliesTemp.createComponent(nodeComp);
