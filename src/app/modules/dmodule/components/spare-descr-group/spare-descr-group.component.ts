...
@Component({
  selector: 'app-spare-descr-group',
  templateUrl: './spare-descr-group.component.html',
  styleUrls: ['./spare-descr-group.component.scss'],
})
export class SpareDescrGroupComponent implements OnInit {

xmlTag = 'spareDescrGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('spareDescrGroupTemp', {static: true, read: ViewContainerRef}) spareDescrGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.spareDescrGroupTemp.createComponent(nodeComp);
