...
@Component({
  selector: 'app-repository-source-dm-ident',
  templateUrl: './repository-source-dm-ident.component.html',
  styleUrls: ['./repository-source-dm-ident.component.scss'],
})
export class RepositorySourceDmIdentComponent implements OnInit {
  xmlTag = 'repositorySourceDmIdentTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('repositorySourceDmIdentTemp', {static: true, read: ViewContainerRef}) repositorySourceDmIdentTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.repositorySourceDmIdentTemp.createComponent(nodeComp);
