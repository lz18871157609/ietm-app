...
@Component({
  selector: 'app-warning-and-caution-para',
  templateUrl: './warning-and-caution-para.component.html',
  styleUrls: ['./warning-and-caution-para.component.scss'],
})
export class WarningAndCautionParaComponent implements OnInit {
xmlTag = 'warningAndCautionParaTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('warningAndCautionParaTemp', {static: true, read: ViewContainerRef}) warningAndCautionParaTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.warningAndCautionParaTemp.createComponent(nodeComp);
