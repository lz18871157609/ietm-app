...
@Component({
  ...
  styleUrls: ['./quality-group.component.scss'],
})
export class QualityGroupComponent implements OnInit {
  xmlTag = 'qualityGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('qualityGroupTemp', {static: true, read: ViewContainerRef}) qualityGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.qualityGroupTemp.createComponent(nodeComp);
