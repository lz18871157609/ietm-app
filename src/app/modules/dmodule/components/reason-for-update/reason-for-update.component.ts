...
@Component({
  selector: 'app-reason-for-update',
  templateUrl: './reason-for-update.component.html',
  styleUrls: ['./reason-for-update.component.scss'],
})
export class ReasonForUpdateComponent implements OnInit {
  xmlTag = 'reasonForUpdateTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reasonForUpdateTemp', {static: true, read: ViewContainerRef}) reasonForUpdateTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reasonForUpdateTemp.createComponent(nodeComp);
