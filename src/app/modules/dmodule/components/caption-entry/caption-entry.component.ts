...
@Component({
  selector: 'app-caption-entry',
  templateUrl: './caption-entry.component.html',
  styleUrls: ['./caption-entry.component.scss'],
})
export class CaptionEntryComponent implements OnInit {
  xmlTag = 'captionEntryTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('captionEntryTemp', {static: true, read: ViewContainerRef}) captionEntryTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.captionEntryTemp.createComponent(nodeComp);
