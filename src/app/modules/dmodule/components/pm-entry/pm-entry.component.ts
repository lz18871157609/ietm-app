...
@Component({
  selector: 'app-pm-entry',
  templateUrl: './pm-entry.component.html',
  styleUrls: ['./pm-entry.component.scss'],
  providers: [DynamicDmComponentService]
})
export class PmEntryComponent implements OnInit {
  xmlTag = 'action';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('pmEntryTemp', {static: true, read: ViewContainerRef}) pmEntryTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.pmEntryTemp.createComponent(nodeComp);
