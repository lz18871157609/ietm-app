...
@Component({
  selector: 'app-supply-descr',
  templateUrl: './supply-descr.component.html',
  styleUrls: ['./supply-descr.component.scss'],
})
export class SupplyDescrComponent implements OnInit {

xmlTag = 'supplyDescrTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('supplyDescrTemp', {static: true, read: ViewContainerRef}) supplyDescrTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.supplyDescrTemp.createComponent(nodeComp);
