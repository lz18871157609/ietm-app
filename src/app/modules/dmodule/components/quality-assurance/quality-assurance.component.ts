...
export class QualityAssuranceComponent implements OnInit {
  xmlTag = 'qualityAssuranceTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('qualityAssuranceTemp', {static: true, read: ViewContainerRef}) qualityAssuranceTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.qualityAssuranceTemp.createComponent(nodeComp);
