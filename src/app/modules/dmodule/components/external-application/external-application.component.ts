...
@Component({
  selector: 'app-external-application',
...
export class ExternalApplicationComponent implements OnInit {
  xmlTag = 'externalApplicationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('externalApplicationTemp', {static: true, read: ViewContainerRef}) externalApplicationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.externalApplicationTemp.createComponent(nodeComp);
