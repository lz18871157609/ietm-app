...
@Component({
  selector: 'app-variable-declarations',
  templateUrl: './variable-declarations.component.html',
  styleUrls: ['./variable-declarations.component.scss'],
})
export class VariableDeclarationsComponent implements OnInit {
xmlTag = 'variableDeclarationsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('variableDeclarationsTemp', {static: true, read: ViewContainerRef}) variableDeclarationsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.variableDeclarationsTemp.createComponent(nodeComp);
