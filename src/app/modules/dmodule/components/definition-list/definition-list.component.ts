...
export class DefinitionListComponent implements OnInit {
  xmlTag = 'definitionListTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('definitionListTemp', {static: true, read: ViewContainerRef}) definitionListTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.definitionListTemp.createComponent(nodeComp);
