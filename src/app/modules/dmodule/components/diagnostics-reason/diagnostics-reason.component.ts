...
@Component({
  selector: 'app-diagnostics-reason',
  templateUrl: './diagnostics-reason.component.html',
  styleUrls: ['./diagnostics-reason.component.scss'],
})
export class DiagnosticsReasonComponent implements OnInit {
  xmlTag = 'diagnosticsReasonTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('diagnosticsReasonTemp', {static: true, read: ViewContainerRef}) diagnosticsReasonTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.diagnosticsReasonTemp.createComponent(nodeComp);
