...
@Component({
  selector: 'app-internal-ref',
  templateUrl: './internal-ref.component.html',
  styleUrls: ['./internal-ref.component.scss'],
})
export class InternalRefComponent implements OnInit {

  
  xmlTag = 'internalRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('internalRefTemp', {static: true, read: ViewContainerRef}) internalRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.internalRefTemp.createComponent(nodeComp);
