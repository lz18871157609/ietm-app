...
@Component({
  selector: 'app-contact-order-value',
  templateUrl: './contact-order-value.component.html',
  styleUrls: ['./contact-order-value.component.scss'],
})
export class ContactOrderValueComponent implements OnInit {

  xmlTag = 'contactOrderValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('contactOrderValueTemp', {static: true, read: ViewContainerRef}) contactOrderValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.contactOrderValueTemp.createComponent(nodeComp);
