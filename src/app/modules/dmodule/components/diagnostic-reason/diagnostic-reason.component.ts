...
@Component({
  selector: 'app-diagnostic-reason',
  templateUrl: './diagnostic-reason.component.html',
  styleUrls: ['./diagnostic-reason.component.scss'],
})
export class DiagnosticReasonComponent implements OnInit {
  xmlTag = 'diagnosticReasonTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('diagnosticReasonTemp', {static: true, read: ViewContainerRef}) diagnosticReasonTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.diagnosticReasonTemp.createComponent(nodeComp);
