...
@Component({
  ...
  templateUrl: './yes-answer.component.html',
  styleUrls: ['./yes-answer.component.scss'],
})
export class YesAnswerComponent implements OnInit {
xmlTag = 'yesAnswerTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('yesAnswerTemp', {static: true, read: ViewContainerRef}) yesAnswerTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.yesAnswerTemp.createComponent(nodeComp);
