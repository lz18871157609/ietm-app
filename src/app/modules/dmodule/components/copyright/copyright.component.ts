...
export class CopyrightComponent implements OnInit {
  xmlTag = 'copyrightTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('copyrightTemp', {static: true, read: ViewContainerRef}) copyrightTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.copyrightTemp.createComponent(nodeComp);
