...
@Component({
  selector: 'app-part-and-serial-number',
  templateUrl: './part-and-serial-number.component.html',
  styleUrls: ['./part-and-serial-number.component.scss'],
})
export class PartAndSerialNumberComponent implements OnInit {
  xmlTag = 'partAndSerialNumberTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('partAndSerialNumberTemp', {static: true, read: ViewContainerRef}) partAndSerialNumberTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.partAndSerialNumberTemp.createComponent(nodeComp);
