...
@Component({
  selector: 'app-external-pub-ref-ident',
  templateUrl: './external-pub-ref-ident.component.html',
  styleUrls: ['./external-pub-ref-ident.component.scss'],
})
export class ExternalPubRefIdentComponent implements OnInit {
  xmlTag = 'externalPubRefIdentTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('externalPubRefIdentTemp', {static: true, read: ViewContainerRef}) externalPubRefIdentTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.externalPubRefIdentTemp.createComponent(nodeComp);
