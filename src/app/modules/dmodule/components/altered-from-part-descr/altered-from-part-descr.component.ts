...
@Component({
  selector: 'app-altered-from-part-descr',
  templateUrl: './altered-from-part-descr.component.html',
  styleUrls: ['./altered-from-part-descr.component.scss'],
})
export class AlteredFromPartDescrComponent implements OnInit {
  xmlTag = 'alteredFromPartDescrTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('alteredFromPartDescrTemp', {static: true, read: ViewContainerRef}) alteredFromPartDescrTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.alteredFromPartDescrTemp.createComponent(nodeComp);
