...
@Component({
  selector: 'app-figure-alts',
  templateUrl: './figure-alts.component.html',
  styleUrls: ['./figure-alts.component.scss'],
})
export class FigureAltsComponent implements OnInit {
  xmlTag = 'figureAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('figureAltsTemp', {static: true, read: ViewContainerRef}) figureAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.figureAltsTemp.createComponent(nodeComp);
