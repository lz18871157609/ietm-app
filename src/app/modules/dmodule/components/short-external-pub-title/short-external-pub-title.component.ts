...
@Component({
  selector: 'app-short-external-pub-title',
  templateUrl: './short-external-pub-title.component.html',
  styleUrls: ['./short-external-pub-title.component.scss'],
})
export class ShortExternalPubTitleComponent implements OnInit {

xmlTag = 'shortExternalPubTitleTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('shortExternalPubTitleTemp', {static: true, read: ViewContainerRef}) shortExternalPubTitleTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.shortExternalPubTitleTemp.createComponent(nodeComp);
