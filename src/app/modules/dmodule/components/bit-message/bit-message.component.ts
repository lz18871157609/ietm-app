...
@Component({
  selector: 'app-bit-message',
  templateUrl: './bit-message.component.html',
  styleUrls: ['./bit-message.component.scss'],
})
export class BitMessageComponent implements OnInit {
  xmlTag = 'bitMessageTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('bitMessageTemp', {static: true, read: ViewContainerRef}) bitMessageTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.bitMessageTemp.createComponent(nodeComp);
