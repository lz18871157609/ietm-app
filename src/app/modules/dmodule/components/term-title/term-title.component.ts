...
@Component({
  selector: 'app-term-title',
  templateUrl: './term-title.component.html',
  styleUrls: ['./term-title.component.scss'],
})
export class TermTitleComponent implements OnInit {

  xmlTag = 'termTitleTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('termTitleTemp', {static: true, read: ViewContainerRef}) termTitleTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.termTitleTemp.createComponent(nodeComp);
