...
@Component({
  selector: 'app-no-spares',
  templateUrl: './no-spares.component.html',
  styleUrls: ['./no-spares.component.scss'],
})
export class NoSparesComponent implements OnInit {

  xmlTag = 'noSparesTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('noSparesTemp', {static: true, read: ViewContainerRef}) noSparesTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.noSparesTemp.createComponent(nodeComp);
