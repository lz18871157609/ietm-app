...
@Component({
  selector: 'app-data-restrictions',
  templateUrl: './data-restrictions.component.html',
  styleUrls: ['./data-restrictions.component.scss'],
})
export class DataRestrictionsComponent implements OnInit {
  xmlTag = 'dataRestrictionsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dataRestrictionsTemp', {static: true, read: ViewContainerRef}) dataRestrictionsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dataRestrictionsTemp.createComponent(nodeComp);
