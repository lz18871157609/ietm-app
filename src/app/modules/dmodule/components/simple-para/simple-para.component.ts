...
@Component({
  selector: 'app-simple-para',
  templateUrl: './simple-para.component.html',
  styleUrls: ['./simple-para.component.scss'],
  providers: [DynamicDmComponentService]
})
export class SimpleParaComponent implements OnInit {
  xmlTag = 'SimplePara';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('simpleParaTemp', {static: true, read: ViewContainerRef}) simpleParaTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.simpleParaTemp.createComponent(nodeComp);
