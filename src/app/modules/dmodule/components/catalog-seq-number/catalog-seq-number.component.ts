...
@Component({
  selector: 'app-catalog-seq-number',
  templateUrl: './catalog-seq-number.component.html',
  styleUrls: ['./catalog-seq-number.component.scss'],
})
export class CatalogSeqNumberComponent implements OnInit {
  xmlTag = 'catalogSeqNumberTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('catalogSeqNumberTemp', {static: true, read: ViewContainerRef}) catalogSeqNumberTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.catalogSeqNumberTemp.createComponent(nodeComp);
