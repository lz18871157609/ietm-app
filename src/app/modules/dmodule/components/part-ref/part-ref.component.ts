...
@Component({
  selector: 'app-part-ref',
  templateUrl: './part-ref.component.html',
  styleUrls: ['./part-ref.component.scss'],
})
export class PartRefComponent implements OnInit {
  xmlTag = 'partRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('partRefTemp', {static: true, read: ViewContainerRef}) partRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.partRefTemp.createComponent(nodeComp);
