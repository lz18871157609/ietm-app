...
@Component({
  selector: 'app-fault-isolation-ref',
  templateUrl: './fault-isolation-ref.component.html',
  styleUrls: ['./fault-isolation-ref.component.scss'],
})
export class FaultIsolationRefComponent implements OnInit {
  xmlTag = 'faultIsolationRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultIsolationRefTemp', {static: true, read: ViewContainerRef}) faultIsolationRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultIsolationRefTemp.createComponent(nodeComp);
