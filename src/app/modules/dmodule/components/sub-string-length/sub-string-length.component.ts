...
@Component({
  selector: 'app-sub-string-length',
  templateUrl: './sub-string-length.component.html',
  styleUrls: ['./sub-string-length.component.scss'],
})
export class SubStringLengthComponent implements OnInit {

xmlTag = 'subStringLengthTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('subStringLengthTemp', {static: true, read: ViewContainerRef}) subStringLengthTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.subStringLengthTemp.createComponent(nodeComp);
