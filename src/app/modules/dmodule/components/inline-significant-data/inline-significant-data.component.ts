...
@Component({
  selector: 'app-inline-significant-data',
  templateUrl: './inline-significant-data.component.html',
  styleUrls: ['./inline-significant-data.component.scss'],
})
export class InlineSignificantDataComponent implements OnInit {

  xmlTag = 'inlineSignificantDataTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('inlineSignificantDataTemp', {static: true, read: ViewContainerRef}) inlineSignificantDataTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.inlineSignificantDataTemp.createComponent(nodeComp);
