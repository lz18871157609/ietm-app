...
@Component({
  selector: 'app-supply-ref',
  templateUrl: './supply-ref.component.html',
  styleUrls: ['./supply-ref.component.scss'],
})
export class SupplyRefComponent implements OnInit {

xmlTag = 'supplyRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('supplyRefTemp', {static: true, read: ViewContainerRef}) supplyRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.supplyRefTemp.createComponent(nodeComp);
