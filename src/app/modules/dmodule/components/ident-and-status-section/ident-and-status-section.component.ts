...
@Component({
  selector: 'app-ident-and-status-section',
  templateUrl: './ident-and-status-section.component.html',
  styleUrls: ['./ident-and-status-section.component.scss'],
})
export class IdentAndStatusSectionComponent implements OnInit {

  xmlTag = 'identAndStatusSectionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('identAndStatusSectionTemp', {static: true, read: ViewContainerRef}) identAndStatusSectionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.identAndStatusSectionTemp.createComponent(nodeComp);
