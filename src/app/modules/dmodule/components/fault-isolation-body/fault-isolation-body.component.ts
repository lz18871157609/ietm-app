...
@Component({
  selector: 'app-fault-isolation-body',
  templateUrl: './fault-isolation-body.component.html',
  styleUrls: ['./fault-isolation-body.component.scss'],
})
export class FaultIsolationBodyComponent implements OnInit {
  xmlTag = 'faultIsolationBodyTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultIsolationBodyTemp', {static: true, read: ViewContainerRef}) faultIsolationBodyTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultIsolationBodyTemp.createComponent(nodeComp);
