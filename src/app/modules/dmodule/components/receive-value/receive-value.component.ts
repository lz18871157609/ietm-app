...
@Component({
  selector: 'app-receive-value',
  templateUrl: './receive-value.component.html',
  styleUrls: ['./receive-value.component.scss'],
})
export class ReceiveValueComponent implements OnInit {
  xmlTag = 'receiveValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('receiveValueTemp', {static: true, read: ViewContainerRef}) receiveValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.receiveValueTemp.createComponent(nodeComp);
