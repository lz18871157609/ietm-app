...
@Component({
  selector: 'app-full-nato-stock-number',
  templateUrl: './full-nato-stock-number.component.html',
  styleUrls: ['./full-nato-stock-number.component.scss'],
})
export class FullNatoStockNumberComponent implements OnInit {
  xmlTag = 'fullNatoStockNumberTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('fullNatoStockNumberTemp', {static: true, read: ViewContainerRef}) fullNatoStockNumberTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.fullNatoStockNumberTemp.createComponent(nodeComp);
