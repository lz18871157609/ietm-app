...
@Component({
  selector: 'app-req-safety',
  templateUrl: './req-safety.component.html',
  styleUrls: ['./req-safety.component.scss'],
})
export class ReqSafetyComponent implements OnInit {
  xmlTag = 'reqSafetyTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqSafetyTemp', {static: true, read: ViewContainerRef}) reqSafetyTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqSafetyTemp.createComponent(nodeComp);
