...
@Component({
  selector: 'app-external-pub-issue',
  templateUrl: './external-pub-issue.component.html',
  styleUrls: ['./external-pub-issue.component.scss'],
})
export class ExternalPubIssueComponent implements OnInit {
  xmlTag = 'externalPubIssueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('externalPubIssueTemp', {static: true, read: ViewContainerRef}) externalPubIssueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.externalPubIssueTemp.createComponent(nodeComp);
