...
export class DisplayTextComponent implements OnInit {
  ...
  @ViewChild('displayTextTemp', {static: true, read: ViewContainerRef}) displayTextTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.displayTextTemp.createComponent(nodeComp);
