...
@Component({
  selector: 'app-from-equip',
  templateUrl: './from-equip.component.html',
  styleUrls: ['./from-equip.component.scss'],
})
export class FromEquipComponent implements OnInit {
  xmlTag = 'fromEquipTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('fromEquipTemp', {static: true, read: ViewContainerRef}) fromEquipTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.fromEquipTemp.createComponent(nodeComp);
