...
@Component({
  selector: 'app-data-conds',
  templateUrl: './data-conds.component.html',
  styleUrls: ['./data-conds.component.scss'],
})
export class DataCondsComponent implements OnInit {
  xmlTag = 'dataCondsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dataCondsTemp', {static: true, read: ViewContainerRef}) dataCondsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dataCondsTemp.createComponent(nodeComp);
