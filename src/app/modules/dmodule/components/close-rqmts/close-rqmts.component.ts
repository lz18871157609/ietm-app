...
@Component({
  selector: 'app-close-rqmts',
  templateUrl: './close-rqmts.component.html',
  styleUrls: ['./close-rqmts.component.scss'],
})
export class CloseRqmtsComponent implements OnInit {
  xmlTag = 'closeRqmtsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('closeRqmtsTemp', {static: true, read: ViewContainerRef}) closeRqmtsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.closeRqmtsTemp.createComponent(nodeComp);
