...
@Component({
  selector: 'app-no-conds',
  templateUrl: './no-conds.component.html',
  styleUrls: ['./no-conds.component.scss'],
})
export class NoCondsComponent implements OnInit {
  xmlTag = 'noCondsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('noCondsTemp', {static: true, read: ViewContainerRef}) noCondsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.noCondsTemp.createComponent(nodeComp);
