...
@Component({
  selector: 'app-system-ident',
  templateUrl: './system-ident.component.html',
  styleUrls: ['./system-ident.component.scss'],
})
export class SystemIdentComponent implements OnInit {

xmlTag = 'systemIdentTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('systemIdentTemp', {static: true, read: ViewContainerRef}) systemIdentTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.systemIdentTemp.createComponent(nodeComp);
