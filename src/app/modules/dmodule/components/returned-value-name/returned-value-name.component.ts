...
@Component({
  selector: 'app-returned-value-name',
  templateUrl: './returned-value-name.component.html',
  styleUrls: ['./returned-value-name.component.scss'],
})
export class ReturnedValueNameComponent implements OnInit {
  xmlTag = 'returnedValueNameTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('returnedValueNameTemp', {static: true, read: ViewContainerRef}) returnedValueNameTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.returnedValueNameTemp.createComponent(nodeComp);
