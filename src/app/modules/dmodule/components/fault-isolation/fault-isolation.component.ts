...
@Component({
  selector: 'app-fault-isolation',
  templateUrl: './fault-isolation.component.html',
  styleUrls: ['./fault-isolation.component.scss'],
})
export class FaultIsolationComponent implements OnInit {
  xmlTag = 'faultIsolationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultIsolationTemp', {static: true, read: ViewContainerRef}) faultIsolationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultIsolationTemp.createComponent(nodeComp);
