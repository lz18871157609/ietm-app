...
@Component({
  ...
  templateUrl: './schedul.component.html',
  styleUrls: ['./schedul.component.scss'],
})
export class SchedulComponent implements OnInit {

xmlTag = 'schedulTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('schedulTemp', {static: true, read: ViewContainerRef}) schedulTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.schedulTemp.createComponent(nodeComp);
