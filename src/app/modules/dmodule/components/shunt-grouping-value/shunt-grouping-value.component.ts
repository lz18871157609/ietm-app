...
@Component({
  selector: 'app-shunt-grouping-value',
  templateUrl: './shunt-grouping-value.component.html',
  styleUrls: ['./shunt-grouping-value.component.scss'],
})
export class ShuntGroupingValueComponent implements OnInit {

xmlTag = 'shuntGroupingValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('shuntGroupingValueTemp', {static: true, read: ViewContainerRef}) shuntGroupingValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.shuntGroupingValueTemp.createComponent(nodeComp);
