...
@Component({
  selector: 'app-dm-node',
  templateUrl: './dm-node.component.html',
  styleUrls: ['./dm-node.component.scss'],
})
export class DmNodeComponent implements OnInit {
  xmlTag = 'dmNodeTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmNodeTemp', {static: true, read: ViewContainerRef}) dmNodeTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmNodeTemp.createComponent(nodeComp);
