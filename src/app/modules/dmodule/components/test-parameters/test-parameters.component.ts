...
export class TestParametersComponent implements OnInit {
  ...
  xmlTag = 'testParametersTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('testParametersTemp', {static: true, read: ViewContainerRef}) testParametersTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.testParametersTemp.createComponent(nodeComp);
