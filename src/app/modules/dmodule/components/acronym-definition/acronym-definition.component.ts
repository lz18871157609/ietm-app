...
@Component({
  selector: 'app-acronym-definition',
  templateUrl: './acronym-definition.component.html',
  styleUrls: ['./acronym-definition.component.scss'],
  providers: [DynamicDmComponentService]
})
export class AcronymDefinitionComponent implements OnInit {
  xmlTag = 'action';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('acronymDefinitionTemp', {static: true, read: ViewContainerRef}) acronymDefinitionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.acronymDefinitionTemp.createComponent(nodeComp);
