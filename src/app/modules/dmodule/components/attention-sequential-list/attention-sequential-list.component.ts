...
@Component({
  selector: 'app-attention-sequential-list',
  templateUrl: './attention-sequential-list.component.html',
  styleUrls: ['./attention-sequential-list.component.scss'],
})
export class AttentionSequentialListComponent implements OnInit {
  xmlTag = 'attentionSequentialListTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('attentionSequentialListTemp', {static: true, read: ViewContainerRef}) attentionSequentialListTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.attentionSequentialListTemp.createComponent(nodeComp);
