...
@Component({
  selector: 'app-req-cond-dm',
  templateUrl: './req-cond-dm.component.html',
  styleUrls: ['./req-cond-dm.component.scss'],
})
export class ReqCondDmComponent implements OnInit {
  xmlTag = 'reqCondDmTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqCondDmTemp', {static: true, read: ViewContainerRef}) reqCondDmTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqCondDmTemp.createComponent(nodeComp);
