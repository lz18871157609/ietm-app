...
@Component({
  selector: 'app-isolation-step',
  templateUrl: './isolation-step.component.html',
  styleUrls: ['./isolation-step.component.scss'],
})
export class IsolationStepComponent implements OnInit {


  xmlTag = 'isolationStepTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('isolationStepTemp', {static: true, read: ViewContainerRef}) isolationStepTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.isolationStepTemp.createComponent(nodeComp);
