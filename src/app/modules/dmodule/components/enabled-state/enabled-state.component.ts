...
@Component({
  selector: 'app-enabled-state',
  templateUrl: './enabled-state.component.html',
  styleUrls: ['./enabled-state.component.scss'],
})
export class EnabledStateComponent implements OnInit {
  xmlTag = 'enabledStateTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('enabledStateTemp', {static: true, read: ViewContainerRef}) enabledStateTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.enabledStateTemp.createComponent(nodeComp);
