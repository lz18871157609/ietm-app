...
@Component({
  selector: 'app-message-alts',
  templateUrl: './message-alts.component.html',
  styleUrls: ['./message-alts.component.scss'],
})
export class MessageAltsComponent implements OnInit {


  xmlTag = 'messageAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('messageAltsTemp', {static: true, read: ViewContainerRef}) messageAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.messageAltsTemp.createComponent(nodeComp);
