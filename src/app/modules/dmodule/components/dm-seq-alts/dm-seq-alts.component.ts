...
@Component({
  selector: 'app-dm-seq-alts',
  templateUrl: './dm-seq-alts.component.html',
  styleUrls: ['./dm-seq-alts.component.scss'],
})
export class DmSeqAltsComponent implements OnInit {
  xmlTag = 'dmSeqAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmSeqAltsTemp', {static: true, read: ViewContainerRef}) dmSeqAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmSeqAltsTemp.createComponent(nodeComp);
