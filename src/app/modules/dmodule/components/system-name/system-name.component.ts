...
xmlTag = 'systemNameTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('systemNameTemp', {static: true, read: ViewContainerRef}) systemNameTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.systemNameTemp.createComponent(nodeComp);
