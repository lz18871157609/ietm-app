...
@Component({
  selector: 'app-warnings-and-cautions',
  templateUrl: './warnings-and-cautions.component.html',
  styleUrls: ['./warnings-and-cautions.component.scss'],
})
export class WarningsAndCautionsComponent implements OnInit {
xmlTag = 'warningsAndCautionsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('warningsAndCautionsTemp', {static: true, read: ViewContainerRef}) warningsAndCautionsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.warningsAndCautionsTemp.createComponent(nodeComp);
