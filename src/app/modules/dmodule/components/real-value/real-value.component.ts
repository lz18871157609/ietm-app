...
@Component({
  selector: 'app-real-value',
  templateUrl: './real-value.component.html',
  styleUrls: ['./real-value.component.scss'],
})
export class RealValueComponent implements OnInit {
  xmlTag = 'realValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('realValueTemp', {static: true, read: ViewContainerRef}) realValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.realValueTemp.createComponent(nodeComp);
