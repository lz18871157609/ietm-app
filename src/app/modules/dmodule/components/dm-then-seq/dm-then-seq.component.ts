...
@Component({
  selector: 'app-dm-then-seq',
  templateUrl: './dm-then-seq.component.html',
  styleUrls: ['./dm-then-seq.component.scss'],
})
export class DmThenSeqComponent implements OnInit {
  xmlTag = 'dmThenSeqTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmThenSeqTemp', {static: true, read: ViewContainerRef}) dmThenSeqTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmThenSeqTemp.createComponent(nodeComp);
