...
@Component({
  selector: 'app-warning-and-cautions-ref',
  templateUrl: './warning-and-cautions-ref.component.html',
  styleUrls: ['./warning-and-cautions-ref.component.scss'],
})
export class WarningAndCautionsRefComponent implements OnInit {
xmlTag = 'warningAndCautionsRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('warningAndCautionsRefTemp', {static: true, read: ViewContainerRef}) warningAndCautionsRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.warningAndCautionsRefTemp.createComponent(nodeComp);
