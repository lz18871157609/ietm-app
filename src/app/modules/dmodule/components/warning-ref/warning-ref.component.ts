...
@Component({
  selector: 'app-warning-ref',
  templateUrl: './warning-ref.component.html',
  styleUrls: ['./warning-ref.component.scss'],
})
export class WarningRefComponent implements OnInit {
xmlTag = 'warningRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('warningRefTemp', {static: true, read: ViewContainerRef}) warningRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.warningRefTemp.createComponent(nodeComp);
