...
@Component({
  selector: 'app-zone-ref',
  templateUrl: './zone-ref.component.html',
  styleUrls: ['./zone-ref.component.scss'],
})
export class ZoneRefComponent implements OnInit {
xmlTag = 'zoneRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('zoneRefTemp', {static: true, read: ViewContainerRef}) zoneRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.zoneRefTemp.createComponent(nodeComp);
