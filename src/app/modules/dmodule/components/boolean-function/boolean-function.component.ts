...
@Component({
  selector: 'app-boolean-function',
  templateUrl: './boolean-function.component.html',
  styleUrls: ['./boolean-function.component.scss'],
})
export class BooleanFunctionComponent implements OnInit {
  xmlTag = 'booleanFunctionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('booleanFunctionTemp', {static: true, read: ViewContainerRef}) booleanFunctionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.booleanFunctionTemp.createComponent(nodeComp);
