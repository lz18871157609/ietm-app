...
export class TaskDurationComponent implements OnInit {
  ...
  xmlTag = 'taskDurationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('taskDurationTemp', {static: true, read: ViewContainerRef}) taskDurationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.taskDurationTemp.createComponent(nodeComp);
