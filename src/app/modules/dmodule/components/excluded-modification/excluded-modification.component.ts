...
@Component({
  selector: 'app-excluded-modification',
  templateUrl: './excluded-modification.component.html',
  styleUrls: ['./excluded-modification.component.scss'],
})
export class ExcludedModificationComponent implements OnInit {
  xmlTag = 'excludedModificationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('excludedModificationTemp', {static: true, read: ViewContainerRef}) excludedModificationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.excludedModificationTemp.createComponent(nodeComp);
