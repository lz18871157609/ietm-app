...
@Component({
  selector: 'app-locate-and-repair-lru-item',
  templateUrl: './locate-and-repair-lru-item.component.html',
  styleUrls: ['./locate-and-repair-lru-item.component.scss'],
})
export class LocateAndRepairLruItemComponent implements OnInit {

  xmlTag = 'locateAndRepairLruItemTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('locateAndRepairLruItemTemp', {static: true, read: ViewContainerRef}) locateAndRepairLruItemTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.locateAndRepairLruItemTemp.createComponent(nodeComp);
