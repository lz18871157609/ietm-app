...
@Component({
  selector: 'app-acronym-term',
  templateUrl: './acronym-term.component.html',
  styleUrls: ['./acronym-term.component.scss'],
  providers: [DynamicDmComponentService]
})
export class AcronymTermComponent implements OnInit {
  xmlTag = 'action';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('acronymTermTemp', {static: true, read: ViewContainerRef}) acronymTermTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.acronymTermTemp.createComponent(nodeComp);
