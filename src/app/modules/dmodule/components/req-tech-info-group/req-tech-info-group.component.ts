...
@Component({
  selector: 'app-req-tech-info-group',
  templateUrl: './req-tech-info-group.component.html',
  styleUrls: ['./req-tech-info-group.component.scss'],
})
export class ReqTechInfoGroupComponent implements OnInit {
  xmlTag = 'reqTechInfoGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqTechInfoGroupTemp', {static: true, read: ViewContainerRef}) reqTechInfoGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqTechInfoGroupTemp.createComponent(nodeComp);
