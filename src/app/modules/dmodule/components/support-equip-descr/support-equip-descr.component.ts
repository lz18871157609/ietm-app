...
@Component({
  selector: 'app-support-equip-descr',
  templateUrl: './support-equip-descr.component.html',
  styleUrls: ['./support-equip-descr.component.scss'],
})
export class SupportEquipDescrComponent implements OnInit {

xmlTag = 'supportEquipDescrTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('supportEquipDescrTemp', {static: true, read: ViewContainerRef}) supportEquipDescrTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.supportEquipDescrTemp.createComponent(nodeComp);
