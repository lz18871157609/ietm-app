...
@Component({
  selector: 'app-assoc-warning-malfunction',
  templateUrl: './assoc-warning-malfunction.component.html',
  styleUrls: ['./assoc-warning-malfunction.component.scss'],
})
export class AssocWarningMalfunctionComponent implements OnInit {
  xmlTag = 'assocWarningMalfunctionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('assocWarningMalfunctionTemp', {static: true, read: ViewContainerRef}) assocWarningMalfunctionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.assocWarningMalfunctionTemp.createComponent(nodeComp);
