...
@Component({
  selector: 'app-definition-title',
  templateUrl: './definition-title.component.html',
  styleUrls: ['./definition-title.component.scss'],
})
export class DefinitionTitleComponent implements OnInit {
  xmlTag = 'definitionTitleTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('definitionTitleTemp', {static: true, read: ViewContainerRef}) definitionTitleTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.definitionTitleTemp.createComponent(nodeComp);
