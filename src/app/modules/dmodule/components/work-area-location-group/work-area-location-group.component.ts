...
@Component({
  selector: 'app-work-area-location-group',
  templateUrl: './work-area-location-group.component.html',
  styleUrls: ['./work-area-location-group.component.scss'],
})
export class WorkAreaLocationGroupComponent implements OnInit {
xmlTag = 'workAreaLocationGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('workAreaLocationGroupTemp', {static: true, read: ViewContainerRef}) workAreaLocationGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.workAreaLocationGroupTemp.createComponent(nodeComp);
