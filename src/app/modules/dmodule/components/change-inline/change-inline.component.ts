...
@Component({
  selector: 'app-change-inline',
  templateUrl: './change-inline.component.html',
  styleUrls: ['./change-inline.component.scss'],
})
export class ChangeInlineComponent implements OnInit {
  xmlTag = 'changeInlineTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('changeInlineTemp', {static: true, read: ViewContainerRef}) changeInlineTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.changeInlineTemp.createComponent(nodeComp);
