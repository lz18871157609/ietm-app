...
@Component({
  selector: 'app-correlated-fault-alts',
  templateUrl: './correlated-fault-alts.component.html',
  styleUrls: ['./correlated-fault-alts.component.scss'],
})
export class CorrelatedFaultAltsComponent implements OnInit {
  xmlTag = 'correlatedFaultAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('correlatedFaultAltsTemp', {static: true, read: ViewContainerRef}) correlatedFaultAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.correlatedFaultAltsTemp.createComponent(nodeComp);
