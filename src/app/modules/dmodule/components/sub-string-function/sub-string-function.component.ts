...
@Component({
  selector: 'app-sub-string-function',
  templateUrl: './sub-string-function.component.html',
  styleUrls: ['./sub-string-function.component.scss'],
})
export class SubStringFunctionComponent implements OnInit {

xmlTag = 'subStringFunctionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('subStringFunctionTemp', {static: true, read: ViewContainerRef}) subStringFunctionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.subStringFunctionTemp.createComponent(nodeComp);
