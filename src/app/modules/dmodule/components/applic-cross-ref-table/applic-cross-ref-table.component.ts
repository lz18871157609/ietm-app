...
@Component({
  selector: 'app-applic-cross-ref-table',
  templateUrl: './applic-cross-ref-table.component.html',
  styleUrls: ['./applic-cross-ref-table.component.scss'],
})
export class ApplicCrossRefTableComponent implements OnInit {
  xmlTag = 'applicCrossRefTableTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('applicCrossRefTableTemp', {static: true, read: ViewContainerRef}) applicCrossRefTableTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.applicCrossRefTableTemp.createComponent(nodeComp);
