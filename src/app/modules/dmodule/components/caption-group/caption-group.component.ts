...
@Component({
  selector: 'app-caption-group',
  templateUrl: './caption-group.component.html',
  styleUrls: ['./caption-group.component.scss'],
})
export class CaptionGroupComponent implements OnInit {
  xmlTag = 'captionGroupTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('captionGroupTemp', {static: true, read: ViewContainerRef}) captionGroupTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.captionGroupTemp.createComponent(nodeComp);
