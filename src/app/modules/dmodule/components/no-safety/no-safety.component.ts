...
@Component({
  selector: 'app-no-safety',
  templateUrl: './no-safety.component.html',
  styleUrls: ['./no-safety.component.scss'],
})
export class NoSafetyComponent implements OnInit {

  xmlTag = 'noSafetyTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('noSafetyTemp', {static: true, read: ViewContainerRef}) noSafetyTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.noSafetyTemp.createComponent(nodeComp);
