...
@Component({
  selector: 'app-dm-ident',
  templateUrl: './dm-ident.component.html',
  styleUrls: ['./dm-ident.component.scss'],
})
export class DmIdentComponent implements OnInit {
  xmlTag = 'dmIdentTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmIdentTemp', {static: true, read: ViewContainerRef}) dmIdentTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmIdentTemp.createComponent(nodeComp);
