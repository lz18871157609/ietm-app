...
@Component({
  selector: 'app-variable-post-set',
  templateUrl: './variable-post-set.component.html',
  styleUrls: ['./variable-post-set.component.scss'],
})
export class VariablePostSetComponent implements OnInit {
xmlTag = 'variablePostSetTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('variablePostSetTemp', {static: true, read: ViewContainerRef}) variablePostSetTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.variablePostSetTemp.createComponent(nodeComp);
