...
@Component({
  selector: 'app-isolation-info',
  templateUrl: './isolation-info.component.html',
  styleUrls: ['./isolation-info.component.scss'],
})
export class IsolationInfoComponent implements OnInit {


  xmlTag = 'isolationInfoTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('isolationInfoTemp', {static: true, read: ViewContainerRef}) isolationInfoTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.isolationInfoTemp.createComponent(nodeComp);
