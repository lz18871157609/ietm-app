...
@Component({
  selector: 'app-pub-media',
  templateUrl: './pub-media.component.html',
  styleUrls: ['./pub-media.component.scss'],
})
export class PubMediaComponent implements OnInit {
  xmlTag = 'pubMediaTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('pubMediaTemp', {static: true, read: ViewContainerRef}) pubMediaTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.pubMediaTemp.createComponent(nodeComp);
