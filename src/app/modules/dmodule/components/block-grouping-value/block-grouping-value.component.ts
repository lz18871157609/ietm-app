...
@Component({
  selector: 'app-block-grouping-value',
  templateUrl: './block-grouping-value.component.html',
  styleUrls: ['./block-grouping-value.component.scss'],
})
export class BlockGroupingValueComponent implements OnInit {
  xmlTag = 'blockGroupingValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('blockGroupingValueTemp', {static: true, read: ViewContainerRef}) blockGroupingValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.blockGroupingValueTemp.createComponent(nodeComp);
