...
@Component({
  selector: 'app-second-verification',
  templateUrl: './second-verification.component.html',
  styleUrls: ['./second-verification.component.scss'],
})
export class SecondVerificationComponent implements OnInit {

xmlTag = 'secondVerificationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('secondVerificationTemp', {static: true, read: ViewContainerRef}) secondVerificationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.secondVerificationTemp.createComponent(nodeComp);
