...
export class PersonnelComponent implements OnInit {
  xmlTag = 'personnelTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('personnelTemp', {static: true, read: ViewContainerRef}) personnelTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.personnelTemp.createComponent(nodeComp);
