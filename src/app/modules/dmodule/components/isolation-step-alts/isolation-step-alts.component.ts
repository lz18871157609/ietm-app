...
@Component({
  selector: 'app-isolation-step-alts',
  templateUrl: './isolation-step-alts.component.html',
  styleUrls: ['./isolation-step-alts.component.scss'],
})
export class IsolationStepAltsComponent implements OnInit {


  xmlTag = 'isolationStepAltsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('isolationStepAltsTemp', {static: true, read: ViewContainerRef}) isolationStepAltsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.isolationStepAltsTemp.createComponent(nodeComp);
