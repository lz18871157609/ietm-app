...
@Component({
  selector: 'app-applicability-segment',
  templateUrl: './applicability-segment.component.html',
  styleUrls: ['./applicability-segment.component.scss'],
})
export class ApplicabilitySegmentComponent implements OnInit {
  xmlTag = 'applicabilitySegmentTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('applicabilitySegmentTemp', {static: true, read: ViewContainerRef}) applicabilitySegmentTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.applicabilitySegmentTemp.createComponent(nodeComp);
