...
export class ContactInfoComponent implements OnInit {
  ...
  xmlTag = 'contactInfoTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('contactInfoTemp', {static: true, read: ViewContainerRef}) contactInfoTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.contactInfoTemp.createComponent(nodeComp);
