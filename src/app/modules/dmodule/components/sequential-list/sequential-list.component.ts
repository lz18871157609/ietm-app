...
@Component({
  selector: 'app-sequential-list',
  templateUrl: './sequential-list.component.html',
  styleUrls: ['./sequential-list.component.scss'],
})
export class SequentialListComponent implements OnInit {

xmlTag = 'sequentialListTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('sequentialListTemp', {static: true, read: ViewContainerRef}) sequentialListTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.sequentialListTemp.createComponent(nodeComp);
