...
@Component({
  selector: 'app-detected-fault',
  templateUrl: './detected-fault.component.html',
  styleUrls: ['./detected-fault.component.scss'],
})
export class DetectedFaultComponent implements OnInit {
  xmlTag = 'detectedFaultTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('detectedFaultTemp', {static: true, read: ViewContainerRef}) detectedFaultTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.detectedFaultTemp.createComponent(nodeComp);
