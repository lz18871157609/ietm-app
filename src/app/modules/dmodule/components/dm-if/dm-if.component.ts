...
@Component({
  selector: 'app-dm-if',
  templateUrl: './dm-if.component.html',
  styleUrls: ['./dm-if.component.scss'],
})
export class DmIfComponent implements OnInit {
  xmlTag = 'dmIfTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmIfTemp', {static: true, read: ViewContainerRef}) dmIfTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmIfTemp.createComponent(nodeComp);
