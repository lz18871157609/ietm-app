...
@Component({
  selector: 'app-quantity-value',
  templateUrl: './quantity-value.component.html',
  styleUrls: ['./quantity-value.component.scss'],
})
export class QuantityValueComponent implements OnInit {
  xmlTag = 'quantityValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('quantityValueTemp', {static: true, read: ViewContainerRef}) quantityValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.quantityValueTemp.createComponent(nodeComp);
