...
@Component({
  selector: 'app-brex-dm-ref',
  templateUrl: './brex-dm-ref.component.html',
  styleUrls: ['./brex-dm-ref.component.scss'],
})
export class BrexDmRefComponent implements OnInit {
  xmlTag = 'brexDmRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('brexDmRefTemp', {static: true, read: ViewContainerRef}) brexDmRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.brexDmRefTemp.createComponent(nodeComp);
