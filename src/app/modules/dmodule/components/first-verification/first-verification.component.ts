...
@Component({
  ...
  styleUrls: ['./first-verification.component.scss'],
})
export class FirstVerificationComponent implements OnInit {
  xmlTag = 'firstVerificationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('firstVerificationTemp', {static: true, read: ViewContainerRef}) firstVerificationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.firstVerificationTemp.createComponent(nodeComp);
