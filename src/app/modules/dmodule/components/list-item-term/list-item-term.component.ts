...
@Component({
  selector: 'app-list-item-term',
  templateUrl: './list-item-term.component.html',
  styleUrls: ['./list-item-term.component.scss'],
})
export class ListItemTermComponent implements OnInit {

  xmlTag = 'listItemTermTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('listItemTermTemp', {static: true, read: ViewContainerRef}) listItemTermTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.listItemTermTemp.createComponent(nodeComp);
