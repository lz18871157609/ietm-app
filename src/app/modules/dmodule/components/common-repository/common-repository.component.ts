...
@Component({
  selector: 'app-common-repository',
  templateUrl: './common-repository.component.html',
  styleUrls: ['./common-repository.component.scss'],
})
export class CommonRepositoryComponent implements OnInit {

  xmlTag = 'commonRepositoryTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('commonRepositoryTemp', {static: true, read: ViewContainerRef}) commonRepositoryTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.commonRepositoryTemp.createComponent(nodeComp);
