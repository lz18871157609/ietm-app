...
@Component({
  selector: 'app-number-function',
  templateUrl: './number-function.component.html',
  styleUrls: ['./number-function.component.scss'],
})
export class NumberFunctionComponent implements OnInit {

  xmlTag = 'numberFunctionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('numberFunctionTemp', {static: true, read: ViewContainerRef}) numberFunctionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.numberFunctionTemp.createComponent(nodeComp);
