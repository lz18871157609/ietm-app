...
export class ProcedureComponent implements OnInit {
  xmlTag = 'procedureTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('procedureTemp', {static: true, read: ViewContainerRef}) procedureTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.procedureTemp.createComponent(nodeComp);
