...
@Component({
  selector: 'app-wiring-data',
  templateUrl: './wiring-data.component.html',
  styleUrls: ['./wiring-data.component.scss'],
})
export class WiringDataComponent implements OnInit {
xmlTag = 'wiringDataTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('wiringDataTemp', {static: true, read: ViewContainerRef}) wiringDataTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.wiringDataTemp.createComponent(nodeComp);
