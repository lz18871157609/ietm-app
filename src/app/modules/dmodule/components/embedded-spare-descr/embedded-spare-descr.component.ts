...
@Component({
  selector: 'app-embedded-spare-descr',
  templateUrl: './embedded-spare-descr.component.html',
  styleUrls: ['./embedded-spare-descr.component.scss'],
})
export class EmbeddedSpareDescrComponent implements OnInit {

  xmlTag = 'embeddedSpareDescrTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('embeddedSpareDescrTemp', {static: true, read: ViewContainerRef}) embeddedSpareDescrTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.embeddedSpareDescrTemp.createComponent(nodeComp);
