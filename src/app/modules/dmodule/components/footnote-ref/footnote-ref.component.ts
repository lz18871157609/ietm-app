...
@Component({
  selector: 'app-footnote-ref',
  templateUrl: './footnote-ref.component.html',
  styleUrls: ['./footnote-ref.component.scss'],
})
export class FootnoteRefComponent implements OnInit {
  xmlTag = 'footnoteRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('footnoteRefTemp', {static: true, read: ViewContainerRef}) footnoteRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.footnoteRefTemp.createComponent(nodeComp);
