...
@Component({
  selector: 'app-req-spares',
  templateUrl: './req-spares.component.html',
  styleUrls: ['./req-spares.component.scss'],
})
export class ReqSparesComponent implements OnInit {
  xmlTag = 'reqSparesTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('reqSparesTemp', {static: true, read: ViewContainerRef}) reqSparesTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.reqSparesTemp.createComponent(nodeComp);
