...
@Component({
  selector: 'app-main-procedure',
  templateUrl: './main-procedure.component.html',
  styleUrls: ['./main-procedure.component.scss'],
})
export class MainProcedureComponent implements OnInit {


  xmlTag = 'mainProcedureTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('mainProcedureTemp', {static: true, read: ViewContainerRef}) mainProcedureTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.mainProcedureTemp.createComponent(nodeComp);
