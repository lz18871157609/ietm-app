...
export class CommonInfoComponent implements OnInit {
  xmlTag = 'commonInfoTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('commonInfoTemp', {static: true, read: ViewContainerRef}) commonInfoTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.commonInfoTemp.createComponent(nodeComp);
