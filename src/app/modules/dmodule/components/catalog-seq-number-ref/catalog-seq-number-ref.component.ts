...
@Component({
  selector: 'app-catalog-seq-number-ref',
  templateUrl: './catalog-seq-number-ref.component.html',
  styleUrls: ['./catalog-seq-number-ref.component.scss'],
})
export class CatalogSeqNumberRefComponent implements OnInit {

  xmlTag = 'catalogSeqNumberRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('catalogSeqNumberRefTemp', {static: true, read: ViewContainerRef}) catalogSeqNumberRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.catalogSeqNumberRefTemp.createComponent(nodeComp);
