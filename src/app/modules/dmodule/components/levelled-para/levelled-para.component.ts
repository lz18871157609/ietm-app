...
@Component({
  ...
  styleUrls: ['./levelled-para.component.scss'],
})
export class LevelledParaComponent implements OnInit {
  xmlTag = 'levelledParaTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('levelledParaTemp', {static: true, read: ViewContainerRef}) levelledParaTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.levelledParaTemp.createComponent(nodeComp);
