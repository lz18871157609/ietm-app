...
@Component({
  selector: 'app-wiring-fields',
  templateUrl: './wiring-fields.component.html',
  styleUrls: ['./wiring-fields.component.scss'],
})
export class WiringFieldsComponent implements OnInit {
xmlTag = 'wiringFieldsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('wiringFieldsTemp', {static: true, read: ViewContainerRef}) wiringFieldsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.wiringFieldsTemp.createComponent(nodeComp);
