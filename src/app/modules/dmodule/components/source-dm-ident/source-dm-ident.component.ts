...
@Component({
  selector: 'app-source-dm-ident',
  templateUrl: './source-dm-ident.component.html',
  styleUrls: ['./source-dm-ident.component.scss'],
})
export class SourceDmIdentComponent implements OnInit {

xmlTag = 'sourceDmIdentTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('sourceDmIdentTemp', {static: true, read: ViewContainerRef}) sourceDmIdentTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.sourceDmIdentTemp.createComponent(nodeComp);
