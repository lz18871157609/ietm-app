...
@Component({
  selector: 'app-dm-code',
  templateUrl: './dm-code.component.html',
  styleUrls: ['./dm-code.component.scss'],
  providers: [DynamicDmComponentService]
})
export class DmCodeComponent implements OnInit {
  xmlTag = 'action';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dmCodeTemp', {static: true, read: ViewContainerRef}) dmCodeTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dmCodeTemp.createComponent(nodeComp);
