...
@Component({
  selector: 'app-cond-cross-ref-table',
  templateUrl: './cond-cross-ref-table.component.html',
  styleUrls: ['./cond-cross-ref-table.component.scss'],
})
export class CondCrossRefTableComponent implements OnInit {

  xmlTag = 'condCrossRefTableTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('condCrossRefTableTemp', {static: true, read: ViewContainerRef}) condCrossRefTableTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.condCrossRefTableTemp.createComponent(nodeComp);
