...
@Component({
  selector: 'app-termination-module-grouping-value',
  templateUrl: './termination-module-grouping-value.component.html',
  styleUrls: ['./termination-module-grouping-value.component.scss'],
})
export class TerminationModuleGroupingValueComponent implements OnInit {

  xmlTag = 'terminationModuleGroupingValueTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('terminationModuleGroupingValueTemp', {static: true, read: ViewContainerRef}) terminationModuleGroupingValueTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.terminationModuleGroupingValueTemp.createComponent(nodeComp);
