...
@Component({
  selector: 'app-fault-sub-system',
  templateUrl: './fault-sub-system.component.html',
  styleUrls: ['./fault-sub-system.component.scss'],
})
export class FaultSubSystemComponent implements OnInit {
  xmlTag = 'faultSubSystemTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultSubSystemTemp', {static: true, read: ViewContainerRef}) faultSubSystemTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultSubSystemTemp.createComponent(nodeComp);
