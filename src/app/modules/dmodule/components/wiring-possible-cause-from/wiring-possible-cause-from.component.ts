...
@Component({
  selector: 'app-wiring-possible-cause-from',
  templateUrl: './wiring-possible-cause-from.component.html',
  styleUrls: ['./wiring-possible-cause-from.component.scss'],
})
export class WiringPossibleCauseFromComponent implements OnInit {
xmlTag = 'wiringPossibleCauseFromTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('wiringPossibleCauseFromTemp', {static: true, read: ViewContainerRef}) wiringPossibleCauseFromTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.wiringPossibleCauseFromTemp.createComponent(nodeComp);
