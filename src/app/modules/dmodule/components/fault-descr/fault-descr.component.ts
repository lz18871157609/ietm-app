...
@Component({
  selector: 'app-fault-descr',
  templateUrl: './fault-descr.component.html',
  styleUrls: ['./fault-descr.component.scss'],
})
export class FaultDescrComponent implements OnInit {
  xmlTag = 'faultDescrTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('faultDescrTemp', {static: true, read: ViewContainerRef}) faultDescrTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.faultDescrTemp.createComponent(nodeComp);
