...
xmlTag = 'workLocationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('workLocationTemp', {static: true, read: ViewContainerRef}) workLocationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.workLocationTemp.createComponent(nodeComp);
