...
@Component({
  selector: 'app-illustrated-parts-catalog',
  templateUrl: './illustrated-parts-catalog.component.html',
  styleUrls: ['./illustrated-parts-catalog.component.scss'],
})
export class IllustratedPartsCatalogComponent implements OnInit {

  xmlTag = 'illustratedPartsCatalogTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('illustratedPartsCatalogTemp', {static: true, read: ViewContainerRef}) illustratedPartsCatalogTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.illustratedPartsCatalogTemp.createComponent(nodeComp);
