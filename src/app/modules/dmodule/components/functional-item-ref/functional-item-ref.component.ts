...
@Component({
  selector: 'app-functional-item-ref',
  templateUrl: './functional-item-ref.component.html',
  styleUrls: ['./functional-item-ref.component.scss'],
})
export class FunctionalItemRefComponent implements OnInit {

  xmlTag = 'functionalItemRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('functionalItemRefTemp', {static: true, read: ViewContainerRef}) functionalItemRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.functionalItemRefTemp.createComponent(nodeComp);
