...
@Component({
  selector: 'app-noreq-support-equips',
  templateUrl: './noreq-support-equips.component.html',
  styleUrls: ['./noreq-support-equips.component.scss'],
})
export class NoreqSupportEquipsComponent implements OnInit {
  xmlTag = 'noreqSupportEquipsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('noreqSupportEquipsTemp', {static: true, read: ViewContainerRef}) noreqSupportEquipsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.noreqSupportEquipsTemp.createComponent(nodeComp);
