...
@Component({
  selector: 'app-super-script',
  templateUrl: './super-script.component.html',
  styleUrls: ['./super-script.component.scss'],
})
export class SuperScriptComponent implements OnInit {

xmlTag = 'superScriptTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('superScriptTemp', {static: true, read: ViewContainerRef}) superScriptTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.superScriptTemp.createComponent(nodeComp);
