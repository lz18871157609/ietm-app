...
@Component({
  selector: 'app-external-pub-code',
  templateUrl: './external-pub-code.component.html',
  styleUrls: ['./external-pub-code.component.scss'],
})
export class ExternalPubCodeComponent implements OnInit {
  xmlTag = 'externalPubCodeTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('externalPubCodeTemp', {static: true, read: ViewContainerRef}) externalPubCodeTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.externalPubCodeTemp.createComponent(nodeComp);
