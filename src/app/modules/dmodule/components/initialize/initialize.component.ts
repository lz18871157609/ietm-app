...
export class InitializeComponent implements OnInit {
  ...
  xmlTag = 'initializeTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('initializeTemp', {static: true, read: ViewContainerRef}) initializeTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.initializeTemp.createComponent(nodeComp);
