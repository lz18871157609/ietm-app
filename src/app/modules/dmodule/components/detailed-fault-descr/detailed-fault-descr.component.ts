...
@Component({
  selector: 'app-detailed-fault-descr',
  templateUrl: './detailed-fault-descr.component.html',
  styleUrls: ['./detailed-fault-descr.component.scss'],
})
export class DetailedFaultDescrComponent implements OnInit {
  xmlTag = 'detailedFaultDescrTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('detailedFaultDescrTemp', {static: true, read: ViewContainerRef}) detailedFaultDescrTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.detailedFaultDescrTemp.createComponent(nodeComp);
