...
@Component({
  selector: 'app-pm-ref',
  templateUrl: './pm-ref.component.html',
  styleUrls: ['./pm-ref.component.scss'],
})
export class PmRefComponent implements OnInit {
  xmlTag = 'pmRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('pmRefTemp', {static: true, read: ViewContainerRef}) pmRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.pmRefTemp.createComponent(nodeComp);
