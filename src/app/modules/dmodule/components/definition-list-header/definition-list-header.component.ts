...
@Component({
  selector: 'app-definition-list-header',
  templateUrl: './definition-list-header.component.html',
  styleUrls: ['./definition-list-header.component.scss'],
})
export class DefinitionListHeaderComponent implements OnInit {
  xmlTag = 'definitionListHeaderTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('definitionListHeaderTemp', {static: true, read: ViewContainerRef}) definitionListHeaderTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.definitionListHeaderTemp.createComponent(nodeComp);
