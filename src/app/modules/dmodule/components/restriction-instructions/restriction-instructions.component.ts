...
@Component({
  selector: 'app-restriction-instructions',
  templateUrl: './restriction-instructions.component.html',
  styleUrls: ['./restriction-instructions.component.scss'],
})
export class RestrictionInstructionsComponent implements OnInit {
  xmlTag = 'restrictionInstructionsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('restrictionInstructionsTemp', {static: true, read: ViewContainerRef}) restrictionInstructionsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.restrictionInstructionsTemp.createComponent(nodeComp);
