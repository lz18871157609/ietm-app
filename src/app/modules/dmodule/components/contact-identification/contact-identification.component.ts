...
export class ContactIdentificationComponent implements OnInit {
  xmlTag = 'contactIdentificationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('contactIdentificationTemp', {static: true, read: ViewContainerRef}) contactIdentificationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.contactIdentificationTemp.createComponent(nodeComp);
