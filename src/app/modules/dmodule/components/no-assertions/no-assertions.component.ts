...
@Component({
  selector: 'app-no-assertions',
  templateUrl: './no-assertions.component.html',
  styleUrls: ['./no-assertions.component.scss'],
})
export class NoAssertionsComponent implements OnInit {
  xmlTag = 'noAssertionsTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('noAssertionsTemp', {static: true, read: ViewContainerRef}) noAssertionsTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.noAssertionsTemp.createComponent(nodeComp);
