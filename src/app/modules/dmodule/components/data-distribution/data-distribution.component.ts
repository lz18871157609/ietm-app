...
export class DataDistributionComponent implements OnInit {
  xmlTag = 'dataDistributionTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('dataDistributionTemp', {static: true, read: ViewContainerRef}) dataDistributionTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.dataDistributionTemp.createComponent(nodeComp);
