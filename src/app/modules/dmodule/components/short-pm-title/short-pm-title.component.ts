...
@Component({
  selector: 'app-short-pm-title',
  templateUrl: './short-pm-title.component.html',
  styleUrls: ['./short-pm-title.component.scss'],
})
export class ShortPmTitleComponent implements OnInit {

xmlTag = 'shortPmTitleTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('shortPmTitleTemp', {static: true, read: ViewContainerRef}) shortPmTitleTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.shortPmTitleTemp.createComponent(nodeComp);
