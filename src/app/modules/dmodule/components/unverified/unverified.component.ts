...
xmlTag = 'unverifiedTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('unverifiedTemp', {static: true, read: ViewContainerRef}) unverifiedTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.unverifiedTemp.createComponent(nodeComp);
