...
export class EstimatedTimeComponent implements OnInit {
  ...
  xmlTag = 'estimatedTimeTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('estimatedTimeTemp', {static: true, read: ViewContainerRef}) estimatedTimeTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.estimatedTimeTemp.createComponent(nodeComp);
