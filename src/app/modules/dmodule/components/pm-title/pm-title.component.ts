...
@Component({
  selector: 'app-pm-title',
  templateUrl: './pm-title.component.html',
  styleUrls: ['./pm-title.component.scss'],
})
export class PmTitleComponent implements OnInit {
  xmlTag = 'pmTitleTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('pmTitleTemp', {static: true, read: ViewContainerRef}) pmTitleTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.pmTitleTemp.createComponent(nodeComp);
