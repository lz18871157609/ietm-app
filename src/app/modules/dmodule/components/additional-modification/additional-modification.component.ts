...
@Component({
  selector: 'app-additional-modification',
  templateUrl: './additional-modification.component.html',
  styleUrls: ['./additional-modification.component.scss'],
})
export class AdditionalModificationComponent implements OnInit {
  xmlTag = 'additionalModificationTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('additionalModificationTemp', {static: true, read: ViewContainerRef}) additionalModificationTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.additionalModificationTemp.createComponent(nodeComp);
