...
@Component({
  selector: 'app-locate-and-repair',
  templateUrl: './locate-and-repair.component.html',
  styleUrls: ['./locate-and-repair.component.scss'],
})
export class LocateAndRepairComponent implements OnInit {

  xmlTag = 'locateAndRepairTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('locateAndRepairTemp', {static: true, read: ViewContainerRef}) locateAndRepairTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.locateAndRepairTemp.createComponent(nodeComp);
