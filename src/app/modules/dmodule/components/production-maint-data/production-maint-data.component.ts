...
@Component({
  selector: 'app-production-maint-data',
  templateUrl: './production-maint-data.component.html',
  styleUrls: ['./production-maint-data.component.scss'],
})
export class ProductionMaintDataComponent implements OnInit {
  xmlTag = 'productionMaintDataTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('productionMaintDataTemp', {static: true, read: ViewContainerRef}) productionMaintDataTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.productionMaintDataTemp.createComponent(nodeComp);
