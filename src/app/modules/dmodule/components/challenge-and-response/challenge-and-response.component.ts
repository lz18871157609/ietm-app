...
@Component({
  selector: 'app-challenge-and-response',
  templateUrl: './challenge-and-response.component.html',
  styleUrls: ['./challenge-and-response.component.scss'],
})
export class ChallengeAndResponseComponent implements OnInit {
  xmlTag = 'challengeAndResponseTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('challengeAndResponseTemp', {static: true, read: ViewContainerRef}) challengeAndResponseTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.challengeAndResponseTemp.createComponent(nodeComp);
