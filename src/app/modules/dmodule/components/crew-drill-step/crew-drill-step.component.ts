...
@Component({
  selector: 'app-crew-drill-step',
  templateUrl: './crew-drill-step.component.html',
  styleUrls: ['./crew-drill-step.component.scss'],
})
export class CrewDrillStepComponent implements OnInit {

  xmlTag = 'crewDrillStepTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('crewDrillStepTemp', {static: true, read: ViewContainerRef}) crewDrillStepTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.crewDrillStepTemp.createComponent(nodeComp);
