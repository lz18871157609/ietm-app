...
@Component({
  selector: 'app-detected-lru-item',
  templateUrl: './detected-lru-item.component.html',
  styleUrls: ['./detected-lru-item.component.scss'],
})
export class DetectedLruItemComponent implements OnInit {
  xmlTag = 'detectedLruItemTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('detectedLruItemTemp', {static: true, read: ViewContainerRef}) detectedLruItemTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.detectedLruItemTemp.createComponent(nodeComp);
