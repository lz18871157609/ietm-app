...
@Component({
  selector: 'app-footnote-remarks',
  templateUrl: './footnote-remarks.component.html',
  styleUrls: ['./footnote-remarks.component.scss'],
})
export class FootnoteRemarksComponent implements OnInit {
  xmlTag = 'footnoteRemarksTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('footnoteRemarksTemp', {static: true, read: ViewContainerRef}) footnoteRemarksTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.footnoteRemarksTemp.createComponent(nodeComp);
