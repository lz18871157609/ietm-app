...
xmlTag = 'serialNumberTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('serialNumberTemp', {static: true, read: ViewContainerRef}) serialNumberTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.serialNumberTemp.createComponent(nodeComp);
