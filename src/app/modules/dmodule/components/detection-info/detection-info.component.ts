...
@Component({
  selector: 'app-detection-info',
  templateUrl: './detection-info.component.html',
  styleUrls: ['./detection-info.component.scss'],
})
export class DetectionInfoComponent implements OnInit {
  xmlTag = 'detectionInfoTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('detectionInfoTemp', {static: true, read: ViewContainerRef}) detectionInfoTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.detectionInfoTemp.createComponent(nodeComp);
