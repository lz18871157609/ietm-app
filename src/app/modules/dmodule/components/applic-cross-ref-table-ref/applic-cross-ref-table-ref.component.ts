...
@Component({
  selector: 'app-applic-cross-ref-table-ref',
  templateUrl: './applic-cross-ref-table-ref.component.html',
  styleUrls: ['./applic-cross-ref-table-ref.component.scss'],
})
export class ApplicCrossRefTableRefComponent implements OnInit {
  xmlTag = 'applicCrossRefTableRefTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('applicCrossRefTableRefTemp', {static: true, read: ViewContainerRef}) applicCrossRefTableRefTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.applicCrossRefTableRefTemp.createComponent(nodeComp);
