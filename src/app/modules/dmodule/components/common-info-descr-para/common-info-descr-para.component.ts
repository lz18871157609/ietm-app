...
@Component({
  selector: 'app-common-info-descr-para',
  templateUrl: './common-info-descr-para.component.html',
  styleUrls: ['./common-info-descr-para.component.scss'],
})
export class CommonInfoDescrParaComponent implements OnInit {
  xmlTag = 'commonInfoDescrParaTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('commonInfoDescrParaTemp', {static: true, read: ViewContainerRef}) commonInfoDescrParaTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.commonInfoDescrParaTemp.createComponent(nodeComp);
