...
@Component({
  selector: 'app-wire-ident',
  templateUrl: './wire-ident.component.html',
  styleUrls: ['./wire-ident.component.scss'],
})
export class WireIdentComponent implements OnInit {
xmlTag = 'wireIdentTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('wireIdentTemp', {static: true, read: ViewContainerRef}) wireIdentTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.wireIdentTemp.createComponent(nodeComp);
