...
@Component({
  selector: 'app-crew-ref-card',
  templateUrl: './crew-ref-card.component.html',
  styleUrls: ['./crew-ref-card.component.scss'],
})
export class CrewRefCardComponent implements OnInit {
  xmlTag = 'crewRefCardTemp';
  text = '';
  @Input('dataSource') dataSource;
  @ViewChild('crewRefCardTemp', {static: true, read: ViewContainerRef}) crewRefCardTemp: ViewContainerRef;
  constructor(
  ...
  createComponent(node, nodeComponent) {
    ...
    const nodeCp = this.crewRefCardTemp.createComponent(nodeComp);
